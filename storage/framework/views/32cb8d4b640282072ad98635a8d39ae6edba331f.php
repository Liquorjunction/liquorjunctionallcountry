...
<html lang="en" >
    ...
    <head><base href="">
        ...
        <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('assets/dashboard/images/fav-logo.png')); ?>">
        <!--begin::Fonts-->
...
<!--end::Page Scripts-->
    ...
    <!--end::Body-->
</html><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/layouts/login_layout.blade.php ENDPATH**/ ?>