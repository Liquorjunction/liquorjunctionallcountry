...
<?php $__env->startSection('title', Helper::language('my_address_label')); ?>
<?php $__env->startSection('content'); ?>
    ...
    <div class="bread-crumb-block">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"> <?php echo e(@Helper::language('my_address_label')); ?></li>
            </ul>
        </div>
    </div>
        ...
        <div class="container">
                ...
                <div class="col-lg-9 col-md-8">
                    ...
                    <div class="row address-row">
                        <div class="col-lg-4 col-sm-6 address-column">
                            <a href="<?php echo e(route('add-address')); ?>" class="common-card add-address">
                        ...
                        <?php $__currentLoopData = $UserAddressData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-sm-6 address-column">
                            <div class="common-card account-address">
                                <h4 class="mb-3"><?php echo e(@Helper::language('default_billing_address')); ?> </h4>
                                ...
                                <a href="tel:+<?php echo e(@$phone_number); ?>" class="body-large"> + <?php echo e(@$phone_number); ?></a>
                                <div class="account-address-links flex-fill">
                                    <a href="<?php echo e(route('edit-address', $data->id)); ?>"
                                        class="red-text-link body-normal text-uppercase"><?php echo e(@Helper::language('edit_label')); ?></a>
                                    <a href="javascript:void(0)"
                                        class="red-text-link body-normal text-uppercase data_id_address"
                                        data-bs-toggle="modal" data-bs-target="#removeItemModal"
                                        data-id=<?php echo e(@$data->id); ?>><?php echo e(@Helper::language('remove_btn')); ?></a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8">
                    ...
                    <div class="row address-row">
                        <?php if($UserBillAddressData->isEmpty()): ?>  
                        <div class="col-lg-4 col-sm-6 address-column">
                            <a href="<?php echo e(route('add-bill-address')); ?>" class="common-card add-address">
                                <svg width="60" height="60" viewBox="0 0 60 60" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <g id="icon_pluz">
                                        <path id="Vector"
                        ...
                        <?php $__currentLoopData = $UserBillAddressData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-4 col-sm-6 address-column">
                            <div class="common-card account-address">
                                <h4 class="mb-3"><?php echo e(@Helper::language('default_billing_address')); ?> </h4>
                                ...
                                <a href="tel:+<?php echo e(@$phone_number); ?>" class="body-large"> + <?php echo e(@$phone_number); ?></a>
                                <div class="account-address-links flex-fill">
                                    <a href="<?php echo e(route('edit-bill-address', $data->id)); ?>"
                                        class="red-text-link body-normal text-uppercase"><?php echo e(@Helper::language('edit_label')); ?></a>
                                    <a href="javascript:void(0)"
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <h5 class="mb-3"><?php echo e(@Helper::language('remove_address')); ?></h5>
                        <p class="body-large mb-4"><?php echo e(@Helper::language('are_you_sure_you_want_to_remove_this_address')); ?>

                        </p>
                        <div class="d-flex justify-content-between gap-2">
                            <button type="submit" class="solid-button w-100" data-bs-dismiss="modal"
                                aria-label="Close"><?php echo e(@Helper::language('cancel_btn')); ?></button>
                            <button type="submit" class="solid-button w-100"
                                onclick="return removeAddress()"><?php echo e(@Helper::language('remove_btn')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-between gap-2">
                            <button type="submit" class="solid-button w-100" data-bs-dismiss="modal"
                                aria-label="Close"><?php echo e(@Helper::language('cancel_btn')); ?></button>
                            <button type="submit" class="solid-button w-100"
                                onclick="return removeBillAddress()"><?php echo e(@Helper::language('remove_btn')); ?></button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function removeAddress() {
            ...
            // alert(product_id);
            action_url = "<?php echo e(route('addressremove')); ?>";
        ...
        function removeBillAddress() {
            ...
            action_url = "<?php echo e(route('billaddressremove')); ?>";
            var csrf = "<?php echo e(csrf_token()); ?>";
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/my-profile/myaddress.blade.php ENDPATH**/ ?>