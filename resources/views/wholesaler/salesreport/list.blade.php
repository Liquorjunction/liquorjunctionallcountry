...
@section('title','Sales Report | Wholesaler Panel')
@section('content')
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.SalesReport') }}</h3>
                <small>
                    <a href="{{ route('adminwholesalerHome') }}">{{ __('backend.home') }}</a> /
                    <span>{{ __('backend.SalesReport') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                {{Form::open(['route'=>'export_salesreport','method'=>'post','style="background :none !important;"','id'=>'export'])}}
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "{!!  route('salesreport.anyData') !!} ";
