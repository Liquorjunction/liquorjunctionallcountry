                           ...
                           {{-- @if(!empty($user_id))
                            ...
                            <li>
                                <a href="{{route('favorite-list')}}" title="{{@Helper::language('my_favorite_list_label')}}">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g id="icon_wishlist">
                                            <path id="Vector" d="M11.5312 4.62479L11.9648 5.09071L12.4336 4.62557C13.7422 3.35789 15.5547 2.78093 17.3359 3.07562C20.0273 3.52135 22 5.83617 22 8.55013V8.77532C22 10.3866 21.3281 11.928 20.1406 13.0268L13.082 19.5768C12.7891 19.8486 12.4023 20 12 20C11.5977 20 11.2109 19.8486 10.918 19.5768L3.85898 13.0268C2.67305 11.928 2 10.3866 2 8.77532V8.55013C2 5.83617 3.97344 3.52135 6.66406 3.07562C8.41016 2.78093 10.2578 3.35789 11.5312 4.62479C11.5312 4.62518 11.4961 4.62479 11.5312 4.62479ZM11.9648 7.72701L10.207 5.90994C9.35938 5.10158 8.15625 4.71798 6.97266 4.91366C5.18555 5.20991 3.875 6.74859 3.875 8.55013V8.77532C3.875 9.87022 4.33242 10.9185 5.13828 11.664L12 18.0315L18.8633 11.664C19.668 10.9185 20.125 9.87022 20.125 8.77532V8.55013C20.125 6.74859 18.8125 5.20991 17.0273 4.91366C15.8438 4.71798 14.6406 5.10158 13.793 5.90994L11.9648 7.72701Z" fill="#242424" />
                                        </g>
                                    </svg>
                                </a>
                            </li>
