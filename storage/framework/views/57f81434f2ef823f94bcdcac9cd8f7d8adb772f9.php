            ...
            <div class="col-12">
                <div class="newsletter-main">
                    <div class="newsletter-wrapper">
                        <h3><?php echo e(\Helper::language('subscribe_our_newsletter')); ?></h3>
                        <form action="" class="mb-0"id ="subscribe_form" >
                            <!-- <div class="subscription-form">
                                <div class="row">
                                    <div class="col-md-9 col-12">
                                        <input type="email" autocomplete="off" name="email" placeholder="<?php echo e(\Helper::language('enter_your_email_address_place')); ?>">
                                        <span style="color:red;" id="newslatter-error"></span>
                                    </div>
                                    <div class="col-md-3 col-12">
                                        <input type="submit" name="submit" value="<?php echo e(\Helper::language('subscribe')); ?>" class="solid-button">
                                    </div>
                                </div>
                            </div> -->
                            
                        <div class="subscription-form">
                            <input type="email" autocomplete="off" id="sub_email" name="email" placeholder="<?php echo e(\Helper::language('enter_your_email_address_place')); ?>">
                            <span style="color:red;" id="newslatter-error"></span>
                            <input type="submit" name="submit" value="<?php echo e(\Helper::language('subscribe')); ?>" class="solid-button">
                        </div>
...
<script>
     ...
     $(document).ready(function() {
        ...
        $('#subscribe_form').submit(function(event) {
            ...
            action_url = "<?php echo e(route('subscribeemail')); ?>";
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/liquour_junction/well-known/resources/views/frontend/newsletter/newsletter.blade.php ENDPATH**/ ?>