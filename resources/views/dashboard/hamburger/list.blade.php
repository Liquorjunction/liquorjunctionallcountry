...
@section('title','Hamburger | Admin Panel')
@section('content')
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.hamburger') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                    <span>{{ __('backend.hamburger') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('hamburger.create')}}">
                                    <i class="material-icons">&#xe02e;</i>
                                    &nbsp; {{ __('backend.NewHamburger') }}
                                </a>
                            </li>
                ...
                {{Form::open(['route'=>'hamburgerUpdateAll','method'=>'post','id'=>'updateAll'])}}
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="label">
                        ...
                        <tr>
                            ...
                            <!-- <th>Id</th> -->
                            <th id="">{{ __('backend.title') }}</th>
                            <th id="">{{ __('backend.short_description') }}</th>
                            <th id="">{{ __('backend.image') }}</th>
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "{!!  route('hamburger.anyData') !!} ";
            ...
            else
            {
               $(".has-value:checked").each(function() { 
                ...
                {  
                   ...
                   if(type == 0)
                   {
                       msg = "Are you sure you want to deactive this hamburger?";
                   }
                   else if(type == 1)
                   {
                       msg = "Are you sure you want to active this hamburger?";
                   }
                   else
                   {
                       msg = "Are you sure you want to delete this hamburger?";
                   }
