...
@include('sweetalert::alert')
 ...
 <main class="site-content">
        <div class="bread-crumb-block">
            <div class="container">
                <ul class="breadcrumb">                    
                    <li><p class="text-grey body-normal fw-light">{{@$productDataCount}} result for<span class="text-black body-normal text-bold ms-1">“Top Sellers”</span></p></li>
                </ul>
            </div>
        </div>        
        <section class="product-listing search-history pt-30 py-80">
            <div class="container">
                <h1><span class="d-inline-block">Top Sellers</span></h1>
                <div class="row product-listing-row">
                	<input type="hidden" name="user_id" id="user_id" value="{{@$user_id}}">
                	@foreach($promoteData as $key2=>$product)
                	<?php
                                $user_id = @$user_id; 
                 ...
                 {{ $promoteData->links('vendor.pagination.custom_pagination') }}
