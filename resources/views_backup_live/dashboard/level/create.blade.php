        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.topicNew') }} Level                </h3>
                <small>
            ...
            <div class="box-body">
                {{Form::open(['route'=>['level.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'labelForm' ])}}
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" id="title" class="form-control" placeholder="Level" value="{{old('title')}}">
                            @if ($errors->has('title'))
                    ...
                    <div class="form-group row m-t-md">
                        <div class="offset-sm-2 col-sm-10">
                            ...
                            <a href="{{ route('level')}}" class="btn btn-default m-t">
