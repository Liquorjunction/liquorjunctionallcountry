<div class="tab-pane {{ Session::get('active_tab') == 'languageSettingsTab' || Session::get('active_tab') == '' ? 'active' : '' }}" id="tab-2">
    ...
    <div class="p-a-sm col-md-12">
        <div class="row">
            ...
            <div class="col-sm-4" id="">
                <label>Delivery Fee :</label> {!! Form::text('delivery_fee', $WebmasterSetting->delivery_fee, [ 'id' => 'delivery_fee', 'class' => 'form-control', 'dir' => 'ltr','maxlength'=>'4', 'onkeypress'=>"return isNumberBlock(event)"]) !!} @if ($errors->has('delivery_fee')) <span class="help-block">
