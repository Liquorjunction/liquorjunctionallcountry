    ...
    <div class="box">
        <div class="box-header dker">
            ...
            <small>
                ...
                <a href="{{ route('wholesalerproduct') }}">{{ __('backenmore.product') }}</a>
            </small>
        </div>
        <div class="box-tool">
            <ul class="nav">
        ...
        <div class="box-body">
            ...
            {{Form::open(['route'=>['wholesalerproduct.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'cmsForm' ])}}
            ...
            <div class="personal_informations">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="category_id" id="category_id" class="form-control" value="{{old('category', @$subcategory->category_id?:"")}}">
                            ...
                            <option value="{{$value->id}}" {{(old('category', @$subcategory->category_id?:"") == $value->id) ? 'selected' : ''}}>{{ucfirst($value->title)}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea class="form-control" id="short_description" name="short_description" placeholder="Product Short Description">{{old('short_description')}}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="checkbox" id="in_store" name="in_store" checked disabled value="1">
                        <label for="in_store"> In Store</label>
                        <input type="checkbox" id="in_online" name="in_online" checked disabled value="1">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <img height="100" width="100" src="{{ asset('assets/dashboard/images/no_image_found.jpg')}}" alt="your image" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <img height="100" width="100" src="{{ asset('assets/dashboard/images/pdf_icon.webp')}}" alt="your image" />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="file" name="property_images[]" id="property_images" class="form-control" placeholder="{{ __('backend.property_images') }}" multiple>
