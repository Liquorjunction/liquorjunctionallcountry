    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <!-- <div class="box-tool">
                ...
                {{Form::open(['route'=>'wholesalerorderUpdateAll','method'=>'post','id'=>'updateAll'])}}
                <div class="bulk-action">
                    <div></div>
                        ...
                        <select name="action" id="action" class="form-control c-select w-sm inline v-middle"
                            ...
                            <!-- <option value="0">{{ __('backend.pendingSelected') }}</option> -->
                            <option value="1">{{ __('backend.Dispatched') }}</option>
                            <option value="2">{{ __('backend.complatedSelected') }}</option>
                            <option value="3">{{ __('backend.cancleSelected') }}</option>
                        </select>
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "{!!  route('order.anyData') !!} ";
