<?php $__env->startSection('title','Stock Report | Admin Panel'); ?>
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3><?php echo e(__('backend.StockReport')); ?></h3>
                <small>
                    <a href="<?php echo e(route('adminHome')); ?>"><?php echo e(__('backend.dashboard')); ?></a> /
                    <span><?php echo e(__('backend.StockReport')); ?></span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                <?php echo e(Form::open(['route'=>'export_stockreport','method'=>'post','style="background :none !important;"','id'=>'export'])); ?>
                ...
                <?php echo e(Form::close()); ?>
                            ...
                            <!-- <li class="nav-item inline">
                                <?php echo e(Form::open(['route'=>'export_stockpdf','method'=>'post','style="background :none !important;"','id'=>'exportpdf'])); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0 manage-space" id="label">
                        ...
                        <tr>
                            ...
                            <!-- <th>Id</th> -->
                            <th id=""><?php echo e(__('backend.sku')); ?></th>
                            <th id=""><?php echo e(__('backend.product_name')); ?></th>
                            <th id=""> <?php echo e(__('backend.brand')); ?></th>
                            <th id=""><?php echo e(__('backend.category')); ?></th>
                            <th id=""><?php echo e(__('backend.subcategory')); ?></th>
                            <th id=""><?php echo e(__('backend.totalqty')); ?></th>
                            <th id=""><?php echo e(__('backend.soldqty')); ?></th>
                            <th id=""><?php echo e(__('backend.availableqty')); ?></th>
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data(startdate, enddate) 
           {
              ...
              var action_url = "<?php echo route('productreport.anyData'); ?> ";
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/stockreport/list.blade.php ENDPATH**/ ?>