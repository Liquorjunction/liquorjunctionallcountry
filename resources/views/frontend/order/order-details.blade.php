                    ...
                    <div class="row">
                        @if ($orderInformation->order_status == 3)
                            <div class="col-12 d-flex justify-content-end mb-2">
                                <div class="">
                                    <a class="solid-button" href="{{ route('printMyOrder', ['id' => $orderInformation->id]) }}" style="padding: 10px 20px;" target="_blank"> <i class="fas fa-print" style="margin-right: 7px;"></i>Print Invoice</a>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="col-12">
                            <div class="common-card order-list order-details">
                                <ul class="order-detail">
                                    <li>
                                        <span
                                            class="body-normal text-dark d-block mb-1">{{ Helper::language('order_placed') }}</span>
                                    ...
                                    @if ($orderInformation->order_type == 1)
                                        <li>
                                            <span
                                                class="body-normal text-dark d-block mb-1">{{ Helper::language('deliver_to') }}</span>
                                            <span class="body-normal text-dark-grey d-block mb-0">
                                                @php
                                ...
                                <li>
                                    <span class="body-normal text-dark d-block mb-1">{{Helper::language('pickup_order')}}</span>
                                    <span class="body-normal text-dark-grey d-block mb-0">
                                        @php
                                ...
                                @endif --}}
                                    <li>
                                        <span
                                            class="body-normal text-dark d-block mb-1">{{ Helper::language('order_type') }}</span>
                                        <span class="body-normal text-dark-grey d-block mb-0">
                                            @if ($orderInformation->order_type == 1)
                                                {{ 'Online' }}
                                            @else
                                    ...
                                    <li class="flex-md-fill">
                                        <span
                                            class="body-normal text-dark d-block mb-1">{{ Helper::language('order_status') }}</span>
                                        <span
                                ...
                                <div class="order-details-info">
                                    <div class="row">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <h5>Delivery Instructions</h5>
                                                         ...
                                                         <div style="margin-bottom:10px;">
                                                             <p class="gift-detail"><b>Delivery Message</b> :- {{$orderData->delivery_instructions}}</p>
                                                         </div>
                                                         @endif
                                                    </div>
                                                    <?php                    
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-12">
                                            ...
                                            <ul class="order-summary-list mb-0">
                                                ...
                                                @endif
                                                 @if (isset($orderInformation->cart_discount) && $orderInformation->cart_discount != 0)
                                                    <li>
                                                        <span class="body-large text-dark-grey">Cart  {{ Helper::language('discount_label') }}</span>
                                                        <span class="body-large text-green"> - {{ @Helper::numberFormat($orderInformation->cart_discount) . ' ' . Helper::Settings('currency_symbol') }}</span>
                                                    </li>
                                                @endif
                                                {{-- Reward Points --}}
                                                @if (isset($orderInformation->orderInfo->reward_amount) && $orderInformation->orderInfo->reward_amount != 0)
                                                    <li>
                                                        <span class="body-large text-dark-grey">Reward {{ Helper::language('discount_label') }}</span>
                                                        <span class="body-large text-green"> - {{ @Helper::numberFormat($orderInformation->orderInfo->reward_amount) . ' ' . Helper::Settings('currency_symbol') }}</span>
                                                    </li>
                                                @endif
                                                ...
                                                @endif
                                                @if (isset($orderInformation->gift_card) && $orderInformation->gift_card != 0)
                                                <li>
                                                    <span
                                                        class="body-large text-dark-grey">Gift Card</span>
                                                    <span class="body-large text-dark-grey">
                                                        {{ @Helper::numberFormat($orderInformation->gift_card) . ' ' . Helper::Settings('currency_symbol') }}</span>
                                                </li>
                                                @endif
                                                <li>
                                                    <span
                                    ...
                                    @if($orderData->recipientName)
                                        <div style="margin-bottom:10px;">
                                            ...
                                            <p class="gift-detail"><b>Gift Recipient Name</b> :- {{$orderData->recipientName}}</p>
                                            @if($orderData->giftMessage)
                                                <p class="gift-detail"><b>Gift Message</b> :- {{$orderData->giftMessage}}</p>
                                            @endif
                                        </div>
                                     @endif
