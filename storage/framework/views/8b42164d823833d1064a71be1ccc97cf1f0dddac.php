...
<?php $__env->startSection('content'); ?>
    ...
    ?>
    <!-- Title Banner -->
    <?php if($categoryDetails->photo): ?>

        <section class="title-banner"
            style="background-image: url(<?php echo e(asset($categoryDetails->photo ? 'uploads/categoryback/' . $categoryDetails->photo : 'assets/frontend/images/default-background.jpg')); ?>); background-repeat: no-repeat; background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <?php if(!empty($subCategoryDetails)): ?>
                            ...
                            ?>
                            <h1 class="mb-0"><?php echo e($sub_title); ?></h1>
                        <?php else: ?>
                            <a href="<?php echo e($categoryDetails->url); ?>" style="text-decoration: none; color: inherit;">
                                <h1 class="mb-0"><?php echo e($category_title); ?></h1>
                            </a>
                        <?php endif; ?>
            ...
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        <a
                            <?php if(!empty($subCategoryDetails)): ?> href="<?php echo e(route('productlist', ['id' => Helper::encodeUrl($categoryDetails->id)])); ?>" <?php endif; ?>>
                            <?php echo e($category_title); ?>

                        </a>
                    </li>
                    <?php if(!empty($subCategoryDetails)): ?>
                        <li class="breadcrumb-item active" aria-current="page"><?php echo e(@$sub_title); ?></li>
                    <?php endif; ?>
                </ul>
            </nav>
        </div>
    ...
    <section class="product-listing">
        <div class="container">
            <div class="row" id = "product_list">
                <div class="col-12">
                    <div class="short-by">
                    <input type="hidden" name="cat_id" id="cat_id" value="<?php echo e(@$category_id); ?>">
                    <input type="hidden" name="subcat_id" id="subcat_id" value="<?php echo e(@$subcategory_id); ?>">

                        <p class="mb-0"><?php echo e(Helper::language('all_products')); ?> ( <span
                                id="total_page_count"><?php echo e(@$total_product_count ?: '0'); ?></span> Items )</p>
                            ...
                            <button type="button" class="solid-button backdrop" data-bs-toggle="offcanvas"
                                ...
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path
                                        ...
                                        fill="#242424" />
                                </svg><?php echo e(Helper::language('filter')); ?>

                            </button>
                        </div>
                    </div>
                    <div class="row product-listing-row" id="table_data">
                        <?php echo $__env->make('frontend.product.ajax_product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="row">
                        <div class="offset-md-5 col-md-7">
                            <div class="show-more">
                                <button
                                    <?php if($total_product_count != 0 && $total_product_count > 16): ?> style="display:block;" <?php else: ?> style="display:none;" <?php endif; ?>
                                    class="solid-button show-more load-more-data"><?php echo e(Helper::language('show_more')); ?></button>
                                <?php if($total_product_count != 0): ?>
                                    <p id="showing"><?php echo e(Helper::language('showing')); ?>

                                        
                                        <span id="p-current-count"><?php echo e($showing_product_count ?: 0); ?> </span> of <span
                                            id="p-total-count"><?php echo e($total_product_count); ?></span>
                                    </p>
                                <?php endif; ?>
                            </div>
                        </div>
...
<div class="offcanvas-body" style="flex-grow: 1; overflow-y: auto;padding-bottom:10px;">
       ...
       <div class="filter-listing" style="padding: 0px 0px " >
           ...
           border: 10px solid  #e4e2e2">
            <?php echo e(Helper::language('category')); ?></span>
               ...
               <div class="filter-list p-3" style="margin:15px">
                   ...
                   <ul id="brand-list">
                       <?php $__currentLoopData = $brandData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $brand_result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <?php
                               $brand_title = session::get('language') == 1 ? $brand_result->title : $brand_result->title_fr;
                           ?>
                           <li>
                               <div class="check-group">
...
clearButton.addEventListener('mouseenter', () => {
    clearButton.style.backgroundColor = '#fbb516';  //  yellow on hover
    clearButton.style.color = '#242424';             //  black
    clearButton.style.border = '2px solid #fbb516';  // Set border to yellow on hover
});

clearButton.addEventListener('mouseleave', () => {
    clearButton.style.backgroundColor = '#fff';     // bg to white
    clearButton.style.color = '#000';                // t ack
    clearButton.style.border = '2px solid #000';     // Set border back to black
});
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".load-more-data").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('productFilterData')); ?>?sort_by=" + sort_by + "&brand_ids=" +
                        ...
                        current_page_count + "&category_id=" + category_id + "&subcategory_id=" + subcategory_id,
                    beforeSend: function() {
                        $(".loader").fadeIn();
 ...
 //     3rd change 
    ...
    var brand_ids = brandsFilterIds();  // Get selected brand filters
    var category_ids = categoryFilterIds();  // Get selected category filters
    var subcategory_ids = subCategoryFilterIds();  // Get selected subcategory filters
    var min_price = $("#min-price").val();  // Get selected min price filter
    var max_price = $("#max-price").val();  // Get selected max price filter
    var sort_by = $("#sort-by").val();  // Get selected sort by option
    var category_id = $("#cat_id").val();
    var subcategory_id = $("#subcat_id").val();
    ...
    $.ajax({
        url: "<?php echo e(route('productFilterData')); ?>",  // Update the URL with your filtering route
        data: {
            sort_by: sort_by,
            brand_ids: brand_ids,
        ...
        success: function(data) {
            $('.loader').css("visibility", "hidden");
            $('#table_data').html(data);  // Update the product listing
            productCountData(); 
        }
    });
}
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/product/product-list.blade.php ENDPATH**/ ?>