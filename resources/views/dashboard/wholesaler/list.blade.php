...
@section('title','Wholesaler | Admin Panel')
@section('content')
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="label">
                        ...
                        <tr>
                            ...
                            <th>{{ __('backend.total_product') }}</th>
...
<script src="https://ajax.aspnetcdn.com/ajax/jquery.validate/1.11.1/jquery.validate.min.js"></script>
    ...
    <script>
        $(document).on('click', '.edit-wholesaler', function(e) {
            $("#editWholesaler").modal({backdrop: false});
         ...
         $(document).on('click', '.show-wholesaler', function(e) {
            $("#showWholesaler").modal({backdrop: false});
            var customer_id = $(this).attr('data-id');
        ...
        $(document).on('click', '.status_active', function(e) {
         ...
         $(document).ready(function () {
            $('#myModal form')[0].reset();
             var test = $("#WholesalerForm").validate({
                ...
                messages: {
                    email: {
                        ...
                        // email: "You must enter a valid email, or comma separate multiple"
                    },
                },
                submitHandler: function(){
                    ...
                    $.ajax({
                            ...
                            for (var errstr of erroJson[err])
                              ...
                              $("span#errorMsg").html('Please enter proper email.');
                              }
                               }
                        });
                }
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data(startdate, enddate) 
           {
              ...
              var action_url = "{!!  route('wholesaler.anyData') !!} ";
