    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.blog_management') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                    <span>{{ __('backend.blog_management') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('blog.create')}}">
                ...
                {{Form::open(['route'=>'blogUpdateAll','method'=>'post','id'=>'updateAll'])}}
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "{!!  route('blog.anyData') !!} ";
        ...
        swal({
            ...
            function() {
                $.ajax({
                    ...
                    url: "{{ route('blog.status_inactive')}}",
                    type: 'POST',
                    data: 'id=' + blog_id,
                    beforeSend: function() {
                        // $(".loader").fadeIn();
