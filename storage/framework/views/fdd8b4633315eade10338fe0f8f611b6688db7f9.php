...
<?php if(!empty($offerProductData) && count($offerProductData) > 0): ?>
<?php
    $last_id = '';
    $i=0
?>
<?php $__currentLoopData = $offerProductData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key2 => $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php
    $product_title='';
        ...
        <div class="bs-content">
            ...
            ?> 
             ...
             <?php if($available_qty>0): ?>
                <a style="display: <?php echo $adisplay ; ?>;" title="<?php echo e(Helper::language('add_to_cart')); ?>"  data-product-id="<?php echo e(Helper::encodeUrl($result->product_id)); ?>"  data-variant-id="<?php echo e($result->id); ?>" data-offer_status="<?php echo e($result->offer_status); ?>"  class="add-bucket"  href="javascript:void(0);"><i class="icon-bucket"></i></a>
            <?php endif; ?>

            <input class="favs-icon checked_box" type="checkbox" id="fav-item-offer<?php echo e($key2); ?>" value="<?php echo e(($fav_data != "") ? '1' : "0"); ?>" <?php echo e(($fav_data != "") ? 'checked' : ""); ?> onclick="return productFav(<?php echo e($result->product_id); ?>,<?php echo e(($fav_data != "") ? '1' : "0"); ?>)" />
            <label  class="favs-button" title="<?php echo e(Helper::language('add_to_favourite')); ?>" for="fav-item-offer<?php echo e($key2); ?>"></label>
        </div>                          
        <div class="load_offer_products_ids"  data-id="<?php echo e(Helper::encodeUrl($result->product_id)); ?>" >  </div>
    </div>
</div>
<?php
    $i++;
?>
<?php if(count($offerProductData)==$i): ?> 
<input type="hidden" <?php if(!empty($product_last_id)): ?> value="<?php echo e($product_last_id); ?>" <?php else: ?> value="<?php echo e($result->product_id); ?>" <?php endif; ?> id="offer-last-id" >
<?php
...
?>
<div id="appen-offer-html<?php echo e($pd_id); ?>" ></div>
<?php endif; ?>
...
<div class="offer_product_counts">
<input type="hidden" id="offerProFcount" value="<?php echo e(@$offer_showing_product_count?:''); ?>">
<input type="hidden" id="offerProTcount" value="<?php echo e(@$offer_total_product_count?:''); ?>">
</div>
<?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/product/ajax_filter_offer.blade.php ENDPATH**/ ?>