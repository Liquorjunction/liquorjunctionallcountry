        <div class="modal-header">
          ...
          <h4 class="modal-title">{{ __('backend.EditMaterialCategory') }}</h4>
        </div>
        ...
        <div class="modal-body">
           ...
           <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="name" id="name" class="form-control" placeholder="Enter Name"  value="{{@$materialData->name}}">
        ...
        <div class="modal-footer">
            <input type="hidden" name="material_category_id" id="material_category_id" value="{{@$materialData->id}}">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
            ...
            $("#materialcategoryEditForm").validate({
                ...
                submitHandler: function(){
                    var form_data = new FormData($('#materialcategoryEditForm')[0]);
