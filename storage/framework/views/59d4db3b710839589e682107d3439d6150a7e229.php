    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3><?php echo e(__('backend.blog_management')); ?></h3>
                <small>
                    <a href="<?php echo e(route('adminHome')); ?>"><?php echo e(__('backend.dashboard')); ?></a> /
                    <span><?php echo e(__('backend.blog_management')); ?></span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="<?php echo e(route('blog.create')); ?>">
                                    <i class="material-icons">&#xe02e;</i>
                                    &nbsp; <?php echo e(__('backend.NewBlog')); ?>
                ...
                <?php echo e(Form::open(['route'=>'blogUpdateAll','method'=>'post','id'=>'updateAll'])); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="label">
                        ...
                        <tr>
                            ...
                            <!-- <th>Id</th> -->
                            <th id=""><?php echo e(__('backend.title')); ?></th>
                            <th id=""><?php echo e(__('backend.short_description')); ?></th>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/1.1.3/sweetalert.css">
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "<?php echo route('blog.anyData'); ?> ";
            ...
            else
            {
               $(".has-value:checked").each(function() { 
                ...
                {  
                   ...
                   if(type == 0)
                   {
                       msg = "Are you sure you want to deactive this blog?";
                   }
                   else if(type == 1)
                   {
                       msg = "Are you sure you want to active this blog?";
                   }
                   else
                   {
        ...
        swal({
            ...
            function() {
                $.ajax({
                    ...
                    url: "<?php echo e(route('blog.status_active')); ?>",
                    type: 'POST',
                    data: 'id=' + blog_id,
                    beforeSend: function() {
                        // $(".loader").fadeIn();
    ...
    $(document).on('click', '.status_inactive', function(e) {
        ...
        swal({
            ...
            function() {
                $.ajax({
                    ...
                    url: "<?php echo e(route('blog.status_inactive')); ?>",
                    type: 'POST',
                    data: 'id=' + blog_id,
                    beforeSend: function() {
                        // $(".loader").fadeIn();
        ...
        {
            $.ajax({
               url: "<?php echo e(route('blogUpdateAll')); ?>",
               type: 'POST',
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/blog/list.blade.php ENDPATH**/ ?>