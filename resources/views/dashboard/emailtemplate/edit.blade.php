        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <h3><i class="material-icons">
                        &#xe02e;</i> Edit {{ __('backend.emailtemplate') }}
                </h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                    <a href="{{ route('emailtemplate') }}">{{ __('backend.emailtemplate') }}</a> / Edit Email Template
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body">
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" id="title" class="form-control" placeholder="Title " value="{{ isset($emailtemplate->title)?$emailtemplate->title:old('title') }}">
                            @if ($errors->has('title'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="subject" id="subject" class="form-control" placeholder="Name" value="{{ isset($emailtemplate->subject)?$emailtemplate->subject:old('subject') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <span class="help-block">
                                <span  style="color: red;" class='validate'>{{ $errors->first('content') }}</span>
                            </span>
                            @endif
                        </div>
                    </div>
