        ...
        <div class="row" id = "product_list">
            <div class="col-12">
                ...
                <div class="row product-listing-row" id="table_data">
                    <?php echo $__env->make('frontend.product.ajax_filter_product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="row">
...
<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".load-more-data").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('loadfilterproductlist')); ?>?sort_by=" + sort_by + "&brand_ids=" +
        ...
        function getProductData() {
            ...
            $.ajax({
                url: "<?php echo e(route('loadfilterproductlist')); ?>", 
                data: {
                    sort_by: sort_by,
                    brand_ids: brand_ids,
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/product/filtered-product-list.blade.php ENDPATH**/ ?>