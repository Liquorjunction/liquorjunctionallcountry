...
<?php $__env->startSection('title','Loyalty | Admin Panel'); ?>
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3><?php echo e(__('backend.loyalty')); ?> Points</h3>
                <small>
                    <a href="<?php echo e(route('adminHome')); ?>"><?php echo e(__('backend.dashboard')); ?></a> /
                    <span><?php echo e(__('backend.loyalty')); ?> Points</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" data-toggle="modal" data-target="#myModal">
                                    ...
                                    &nbsp; <?php echo e(__('backend.NewLoyalty')); ?>
                ...
                <?php echo e(Form::open(['route'=>'loyaltyUpdateAll','method'=>'post','id'=>'updateAll'])); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="label">
                        ...
                        <tr>
                            ...
                            <th id=""><?php echo e(__('backend.minimum_purchase_amount')); ?></th>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><?php echo e(__('backend.AddLoyalty')); ?></h4>
        </div>
        <form class="cmxform" id="loyaltyForm" method="post" action="" autocomplete="off">
        <div class="modal-body">

            <div class="form-group row">
                <label class="col-sm-5 form-control-label"><?php echo __('backend.minimum_purchase_amount'); ?> <span class="valid_field">*</span></label>
                <div class="col-sm-7">
                    <input type="text" name="minimum_purchase_amount" onkeypress="return isNumberBlock(event)" id="minimum_purchase_amount" class="form-control"  placeholder="Minimum Purchase Amount" value="<?php echo e(old('minimum_purchase_amount')); ?>">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="text" name="loyalty_percentage" id="loyalty_percentage" onkeypress="return isNumberBlock(event)" class="form-control" placeholder="e.g. 25 for 25%" value="<?php echo e(old('loyalty_percentage')); ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="text" name="maximum_points" id="maximum_points" onkeypress="return isNumberBlock(event)" class="form-control" placeholder="200 GHS" value="<?php echo e(old('maximum_points')); ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="text" name="points_per_ghs" onkeypress="return isNumberBlock(event)" class="form-control" placeholder="e.g. 50 = 2 GHS" value="<?php echo e(old('points_per_ghs')); ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="text" name="redeem_ghs_value" onkeypress="return isNumberBlock(event)" class="form-control" placeholder="e.g. 2 for 50 points = 2 GHS" value="<?php echo e(old('redeem_ghs_value')); ?>">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-7">
                    <input type="text" name="max_redeem_percentage" onkeypress="return isNumberBlock(event)" class="form-control" placeholder="e.g. 10 for 10%" value="<?php echo e(old('max_redeem_percentage')); ?>">
                </div>
            </div>
    ...
    return true;
        ...
        $(document).on('click', '.edit-loyalty', function(e) {
            ...
            $.ajax({
               ...
               url: "<?php echo e(route('loyalty.edit')); ?>",
               type: 'POST',
        ...
        $(document).on('click', '.show-loyalty', function(e) {
            ...
            $.ajax({
               ...
               url: "<?php echo e(route('loyalty.show')); ?>",
               type: 'POST',
               data: 'loyalty_id='+loyalty_id,
               success: function (response) {
        ...
        $(document).on('click', '.status_active', function(e) {
            ...
            $.ajax({
               ...
               url: "<?php echo e(route('loyalty.status_active')); ?>",
               type: 'POST',
               data: 'loyalty_id='+loyalty_id,
               beforeSend: function(){
                                    // $(".loader").fadeIn();
               ...
               success: function (response) {
                $('.loader').css("visibility", "visible");
                    window.location.href = "<?php echo e(route('loyalty')); ?>";
               },
               error: function (response) {
                   alert(response.responseText);
               }
        ...
        $(document).on('click', '.status_inactive', function(e) {
            ...
            $.ajax({
               ...
               url: "<?php echo e(route('loyalty.status_inactive')); ?>",
               type: 'POST',
               data: 'loyalty_id='+loyalty_id,
               beforeSend: function(){
                                    // $(".loader").fadeIn();
    ...
    $('#myModal form')[0].reset();
            var test = $("#loyaltyForm").validate({
                ...
                submitHandler: function(){
                    ...
                    action_url = "<?php echo e(route('loyalty.store')); ?>";
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "<?php echo route('loyalty.anyData'); ?> ";
        ...
        {
            $.ajax({
               url: "<?php echo e(route('loyaltyUpdateAll')); ?>",
               type: 'POST',
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/loyalty/list.blade.php ENDPATH**/ ?>