                            ...
                            <div class="form-group" style="border: 1px solid #DDDDDD; margin-bottom: 15px;padding: 15px 20px 0px 20px;">
                                ...
                                <div class="mt-2 mb-2">
                                    ...
                                    <div class="radio-group">
                                        <input id="user_drop" class="radioPurchase" type="radio" name="delivery_options" {{ @$UserAddressData->delivery_options == 1 ? 'checked' : '' }} value="1" />
                                        <label for="user_drop">Hand over to Me</label>
                                    </div>
                                    &nbsp;&nbsp;
                                    <div class="radio-group">
                                        <input id="door_drop"  {{ @$UserAddressData->delivery_options == 2 ? 'checked' : '' }} value="2" class="radioPurchase" type="radio" name="delivery_options" />
                                ...
                                <div class="form-group">
                                    <textarea name="instruction" id="instruction" col="2" rows="1" placeholder="E.g. Leave at front door">{{@$UserAddressData->delivery_instructions}}</textarea>
                                </div>
                            </div>
