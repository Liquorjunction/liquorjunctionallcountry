        ...
        <div class="container">
            <div class="row" id = "product_list">
                <div class="col-12">
                    ...
                    <input type="hidden" name="subcat_id" id="subcat_id" value="{{@$subcategory_id}}">
...
<div class="card-footer" style="padding: 31px;">
   <div class="filter-button">
      ...
      {{-- //use card body/header for price category and footer for clear and apply filter div 
            so scrollbar will not get hidden under apply filter div  --}}
            {{-- filterbutton --}}
    <script>
        // changed
...
clearButton.addEventListener('mouseleave', () => {
 ...
 //     3rd change 
    ...
    $.ajax({
        url: "{{ route('productFilterData') }}",  // Update the URL with your filtering route
        data: {
            sort_by: sort_by,
            brand_ids: brand_ids,
