...
<div class="bread-crumb-block">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{Helper::language('my_orders')}}</li>
        </ul>
    </div>
</div>
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="common-card recent-order order-list">
                    <ul class="order-detail">
                        <li>
                            <span class="body-normal text-dark d-block mb-1">{{Helper::language('order_placed')}}</span>
                        ...
                        <li>
                            <span class="body-normal text-dark d-block mb-1">{{Helper::language('deliver_to')}}</span>
                            <span class="body-normal text-dark-grey d-block mb-0">
                            @php
                        ...
                        <li>
                            <span class="body-normal text-dark d-block mb-1">{{Helper::language('order_pickup_from')}}</span>
                            <span class="body-normal text-dark-grey d-block mb-0">
                                @php
                        ...
                        <li>
                            <span class="body-normal text-dark d-block mb-1">{{Helper::language('order_type')}}</span>
                            <span class="body-normal text-dark-grey d-block mb-0">
                            @if($result->order_type==1)
                                {{'Online'}}
                        ...
                        <li>
                            <span class="body-normal text-dark d-block mb-1">{{Helper::language('order_status')}}</span>
                            <span class="body-normal text-dark-grey d-block mb-0">{{Helper::getOrderStatus($result->order_status)}}</span>
                        </li>
                         <li class="flex-sm-fill">
                            <span class="body-normal text-dark d-block mb-1">{{ Helper::language('total_amount_label') }}</span>
                            <span class="body-normal text-dark-grey d-block mb-0">{{$result->payable_amount.Helper::Settings( 'currency_symbol')}}</span>
                        </li>
                        <li>
                            ...
                            <ul>
                                {{-- <li class="product-pricing">
                                    @if($result->payable_amount !=0) 
                                        <h5>
                                            {{$result->payable_amount.Helper::Settings( 'currency_symbol')}}
                                        </h5>
                                    @endif
                                </li>                                         --}}
                            </ul>
