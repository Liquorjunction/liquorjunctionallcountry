...
jQuery(document).ready(function() {
    jQuery('.header_search_icon').click(function() {
        jQuery('.header_search_box').slideToggle("fast");
    });
});

/* Instructors Slider */

jQuery('#instructors_slider').owlCarousel({
    items:4,
    loop:true,
    nav: true,
    dots:false,
...
jQuery('#variety_slider').owlCarousel({
  loop:true,
  nav: true,
  dots:false,
  margin:24,
...
$(window).on("load resize", function(e) {
  if ($(window).width() > 1919) {
      $(".filter_item_content").hide();
  } else {
      $(".filter_item_content").show();
  }
});

/* Course Toggle */

jQuery('.course_intro_title').click(function() {
  if (jQuery(window).width() < 1920) {
      jQuery(this).next().slideToggle(300);
      jQuery(this).toggleClass("active");
  }
...
jQuery(document).ready(function(){ 
      ...
      const uploadButtonText = document.querySelector('.upload-button-text');
      const uploadFilename = document.querySelector('.upload-filename');
      const fileInput = document.getElementById('upload_filename');
      fileInput.onchange = () => uploadFile(fileInput.files[0]);
...
function ImgUpload() {
  ...
  // $('body').on('click', ".delete_file_name", function (e) {
  //   var file = $(this).parent().data("file");
  //   for (var i = 0; i < imgArray.length; i++) {
  //     if (imgArray[i].name === file) {
  //       imgArray.splice(i, 1);
                        ...
                        },
                        {
                          ...
                          value: function (emojiInput) {
                            ...
                            emojiCategories.push({
                              name: "faces",
                              icon:
                                '<i id="faces" data-name="Layer 1" class="material-icons">&#xE24e</i>'
                            }),
                              emojiCategories.push({
                                name: "animals",
                                icon:
                                  '<i id="animals" data-name="Layer 1" class="material-icons">&#xE91d</i>'
                              }),
                              emojiCategories.push({
                                name: "food",
                                icon:
                                  '<i id="food" data-name="Layer 1" class="material-icons">&#xE56c</i>'
                              }),
                              emojiCategories.push({
                                name: "sport",
                                icon:
                                  '<i id="sport" data-name="Layer 1" class="material-icons">&#xEb43</i>'
                              }),
                              emojiCategories.push({
                                name: "transport",
                                icon:
                                  '<i id="transport" data-name="Layer 1" class="material-icons">&#xE570</i>'
                              }),
                              emojiCategories.push({
                                name: "objects",
                                icon:
                                  '<i id="objects" data-name="Layer 1" class="material-icons">&#xE839</i>'
                              }),
                              emojiCategories.push({
                                name: "symbols",
                                icon:
                                  '<i id="symbols" data-name="Layer 1" class="material-icons">&#xEb4a</i>'
                              });
...
.on("click", ".video_container .video-add", function(e) {
  ...
  current_obj
    ...
    .addClass("action-button-previous");
...
$('#instructors_slider').owlCarousel({
  items:4,
  loop:true,
  nav: true,
  dots:false,
