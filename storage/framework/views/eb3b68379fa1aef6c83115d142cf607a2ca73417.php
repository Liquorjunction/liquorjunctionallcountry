...
<?php $__env->startSection('title','ForgotOTP'); ?>
    ...
    <div class="container">
        <div id="Register">
            <div class="registration-content">
                <h1 class="text-center mb-2"><?php echo e(@Helper::language('otp_verification_header')); ?></h1>
                <h6 class="text-center text-dark-grey mb-0"><?php echo e(@Helper::language('enter_the_verification_code_we_just_sent_on')); ?> <?php echo e(@$forgot_email); ?></h6>

                <div class="registration-card">
                    <form action="#" class="row registration-form" method="POST" enctype="multipart/form-data" id="otp_forgot_form">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <span class="help-block" id="errorMessagecommon" style="display:none">
                                    <span style="color: red;display: none;" id="errorMsgcommon" class='validate validate-error text-center'></span>
                                </span>
                                <!-- <p class="otp-timmer">Expiring in <span id="some_div" ><?php echo e($invert == 1 ? '00:00' : $elapsed); ?></span></p> -->
                                <span class="d-block text-center body-large text-light-grey" id="exp_span"><?php echo e(@Helper::language('expiring_in')); ?>

                                    <span class="text-center body-large text-light-grey" id="some_div"><?php echo e($invert == 1 ? '00:00' : $elapsed); ?></span>
                                </span>
                            </div>
                        </div>
                        <div class="col-12">
                            <button type="submit" class="solid-button w-100"><?php echo e(@Helper::language('verify_btn_label')); ?></button>
                            ...
                            <p class="text-center"><?php echo e(@Helper::language('didnot_receive_otp')); ?><a href="#" onclick="return resendOtp()" id="resendotp"><?php echo e(@Helper::language('resend_btn')); ?></a></p>
                        </div>
                    </form>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        //             location.replace("<?php echo e(route('websitelogin')); ?>");
        //         } else {
        //             location.reload();
        //         }
        //     });
    ...
    $('#otp_forgot_form').on("submit", function(e) {
        e.preventDefault();
        var frm = $('#otp_forgot_form');
        var formData = new FormData(frm[0]);
        $.ajax({
            url: "<?php echo e(route('websiteotpforgotverificationpost')); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function(response) {
                // return false;
                $('.loader').css("visibility", "visible");
                var url = "<?php echo e(route('forgotchange-password')); ?>";
    ...
    function resendOtp() {
        // alert()
        action_url = "<?php echo e(route('websiteforgotresendotp')); ?>";
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/auth/forgot-otp.blade.php ENDPATH**/ ?>