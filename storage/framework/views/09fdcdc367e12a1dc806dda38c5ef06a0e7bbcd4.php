...
<?php $__env->startSection('title',Helper::language('edit_address')); ?>
...
<div class="bread-crumb-block">
    <div class="container">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?php echo e(@Helper::language('edit_address')); ?></li>
        </ul>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <h2><?php echo e(@Helper::language('edit_address')); ?></h2>
                <div class="common-card">
                    <form class="row edit-bill-address-form" id="edit_bill_address_form">
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group">
                                <label for=""><?php echo e(@Helper::language('name_label_web')); ?> <span class="text-red">*</span></label>
                                <input type="text" value="<?php echo e(@$UserAddressData->name); ?>" placeholder="<?php echo e(@Helper::language('enter_name_web')); ?>" name="bill_name" id="bill_name" class="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group has-validation">
                                ...
                                <div class="input-group phone-number">
                                    <select class="numbers" name="bill_phonecode" id="bill_phonecode" value="<?php echo e(@$UserAddressData->phonecode); ?>">
                                    ...
                                    <input type="tel" value="<?php echo e(@$UserAddressData->phone); ?>" placeholder="<?php echo e(@Helper::language('enter_phone_number_place')); ?> " name="bill_phone" maxlength="15" id="bill_phone">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="bill_country_id" id="bill_country_id" onchange="getSubCatList(this)" class="form-select" value="<?php echo e(@$UserAddressData->country_id); ?>">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo e(@$UserAddressData->city); ?>" name="bill_city" id="bill_city" placeholder="<?php echo e(@Helper::language('enter_city_label')); ?>" class="">
                                <div class="invalid-feedback">
                                    Please enter City.
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea name="bill_address" id="bill_address" placeholder="<?php echo e(@Helper::language('enter_street_address')); ?>" col="5" rows="2"><?php echo e(@$UserAddressData->address); ?></textarea>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="bill_zip_code" id="bill_zip_code" placeholder="<?php echo e(@Helper::language('enter_code_place')); ?>" value="<?php echo e(@$UserAddressData->zip_code); ?>" class="required" placeholder="Enter Zip Code <?php echo e(@Helper::language('name_label_web')); ?>" required>
                                <div class="invalid-feedback">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6" style="margin-bottom:15px ">
                            <div class="form-check" style="display: flex; align-items: center">
                                <input class="form-check-input" type="checkbox" value="" id="defaultAdd" <?php echo e(@$UserAddressData->default==1 ? 'checked': ''); ?>>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <input type="hidden" name="edit_bill_address_id" id="edit_bill_address_id" value="<?php echo e(@$UserAddressData->id); ?>">
...
<script type="text/javascript">
    ...
    var test = $("#edit_bill_address_form").validate({
        rules: {
            bill_name: {
                required:true,
                maxlength: 40,
        ...
        submitHandler: function() {
            var form_data = new FormData($('#edit_bill_address_form')[0]);
    ...
    function getAreaList(thisitem) {
        ...
        var idCountry = $('#bill_region_id').val();
        var cat_id = $('#cat_id').val();
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/my-profile/edit-bill-address.blade.php ENDPATH**/ ?>