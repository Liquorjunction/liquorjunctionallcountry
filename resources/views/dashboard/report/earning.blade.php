...
<div class="padding school-report-manage list-school">
    <div class="box">
        ...
        <div class="row margin filter_message" style="margin-top: -50px;">
            ...
            <div class="col-xs-6">
                {{Form::open(['route'=>'report.earning-filter','style="background :none !important;"','method'=>'post','id'=>'filter_form'])}}
                <div class="bulk-action" style="float: right;">
                    ...
                    <?php $report =  route('earning-report'); ?>
                    ...
                    {{Form::close()}}
                    {{Form::open(['route'=>'report.earning-export-pdf','method'=>'post','style="background :none !important;"','id'=>'export'])}}
                    ...
                    {{Form::close()}}
                    {{Form::open(['route'=>'report.earning-export','method'=>'post','style="background :none !important;"','id'=>'export1'])}}
