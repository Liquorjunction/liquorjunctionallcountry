...
<?php $__env->startSection('title',Helper::language('checkout_label')); ?>
...
<div class="bread-crumb-block">
    <div class="container custom">
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> <?php echo e(@Helper::language('checkout_label')); ?></li>
        </ul>
    </div>
</div>
...
<section class="checkout pt-20 pb-60">
    <div class="container custom">
        <div class="row">
            <div class="col-lg-12">
                <h2><?php echo e(@Helper::language('checkout_label')); ?></h2>
                <div class="new-home">
                    <form class="purchase-option">
                        <div class="radio-group">
                            ...
                            <label for="radioPurchaseOne"><?php echo e(@Helper::language('online_label_web')); ?></label>
                        </div>
                        <div class="radio-group">
                            <input id="radioPurchaseTwo" value="2" class="radioPurchase" type="radio" name="purchase_radio" data-class="pickup-order-main" />
                            <label for="radioPurchaseTwo"><?php echo e(@Helper::language('pickup_order')); ?></label>
                        </div>
                    </form>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 checkout-col contact-information">
                    ...
                    <div class="checkout-heading-flex-group">
                        <h5 class="mb-0"><?php echo e(@Helper::language('contact_details_web')); ?></h5>
                        <?php
                        // dd();
                        ?>
                        <p class="after-login"><?php echo e(($userData->first_name).' '.($userData->last_name)); ?> | <a href="mailto:<?php echo e(@$userData->email); ?>" class="border-button"><?php echo e(@$userData->email); ?></a></p>


                        <input type="hidden" name="userName" id="userName" value="<?php echo e($userData->first_name); ?>">
                        <input type="hidden" name="userPhone" id="userPhone" value="<?php echo e($userData->phone); ?>">
                    ...
                    <?php $__currentLoopData = $UserAddressData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <form class="checkout-form">
                        <div class="address-group radio-group">
                            <div class="radio-btn">
                                <input id="radioAddress<?php echo e($data->id); ?>" <?php echo e(($key == 0) ? 'checked' : ""); ?> type="radio" value="<?php echo e($data->id); ?>" name="address_radio" class="addressRadioCurrent" />
                                <label onclick="checkDeliveryAddressByArea('<?php echo e($data->id); ?>')" for="radioAddress<?php echo e($data->id); ?>"></label>
                                <div class="detail">
                                    <h5><?php echo e(@Helper::language('default_billing_address')); ?></h5>
                                    <p class="black-text">
                                        <?php
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="hidden" name="address_id" id="address_id" value="<?php echo e(@$data->id); ?>">
                                        <input type="hidden" class="user_address_id" name="user_address_id" value="<?php echo e(@$data->id); ?>"> <input type="hidden" name="checkout_page" id="checkout_page" value="1">
                                        <input type="hidden" name="checkout_address" id="checkout_address" value="1">
                                        <input type="hidden" name="address_id" id="address_id" value="<?php echo e(@$data->id); ?>">
                                        <input type="hidden" class="user_address_id" name="user_address_id" value="<?php echo e(@$data->id); ?>">
                            ...
                            <input type="hidden" name="address_id" id="address_id" value="<?php echo e(@$data->id); ?>">
                            <input type="hidden" class="user_address_id" name="user_address_id" value="<?php echo e(@$data->id); ?>">
                            <a href="javascript:void(0)" class="border-button EditAddress"><?php echo e(@Helper::language('edit_label')); ?></a>
                        </div>
                    ...
                    <form class="checkout-form" id="addressNewForm">
                        <div class="address-group radio-group">
                            <div class="radio-btn">
                                <label class="custom-checkbox-label">
                                  ...
                                  <span class="detail">
                                    <p class="black-text add_new_address_div"><?php echo e(@Helper::language('add_new_address_label')); ?></p>
                                  </span>
                                </label>
                              </div>                              
                        </div>
                        <div class="add-new-address addressRadioCurrentShow d-none">
                            <div class="checkout-heading-flex-group">
                                <h5 class="mb-0"><?php echo e(@Helper::language('add_address')); ?></h5>
                            </div>
                            ...
                            <div class="form-group has-validation">
                                ...
                                <div class="input-group phone-number">
                                    ...
                                    <input type="tel" value="<?php echo e(old('phone')); ?>" placeholder="<?php echo e(@Helper::language('enter_phone_number_place')); ?> " maxlength="15" name="phone" id="phone">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo e(old('city')); ?>" placeholder="Enter city" name="city" id="city" class="form-control">
                            </div>
                            <div class="form-group">
                                ...
                                <div class="invalid-feedback">
                                    <?php echo e(@Helper::language('checkout_street_address')); ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="<?php echo e(old('zip_code')); ?>" placeholder="Enter zip code" name="zip_code" id="zip_code" class="form-control">
                            </div>
                            ...
                            <input type="hidden" name="checkout_page" id="checkout_page" value="<?php echo e(@$checkout_page_count); ?>">
                    ...
                    <?php if($user && !$user->is_guest_user == 1): ?>
                    ...
                    <div id="billingAddressContainer">
                        <?php if($UserBillAddressData->isEmpty() && !$user->is_guest_user == 1): ?>
                            <div class="mt-20">
                                <a href="<?php echo e(route('add-bill-address')); ?>" ><u>Add New Billing Address.</u></a>
                            </div>
                        <?php else: ?>
                            <?php $__currentLoopData = $UserBillAddressData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <form class="checkout-form">
                                <div class="address-group">
                                    ...
                                    <input type="hidden" name="bill_address_id" id="bill_address_id" value="<?php echo e(@$data->id); ?>">
                                    <input type="hidden" class="user_bill_address_id" name="user_bill_address_id" id="user_bill_address_id" value="<?php echo e(@$data->id); ?>"> 
                                    <a href="javascript:void(0)" class="border-button EditBillAddress"><?php echo e(@Helper::language('edit_label')); ?></a>
                                </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </form>
                        <?php endif; ?>
                ...
                <div class="col-xl-4 col-md-6 checkout-col store-contact-information" style="display: none;">
                    <h5 class="checkout-head">1. <?php echo e(@Helper::language('store_label_web')); ?></h5>
                    <div class="checkout-heading-flex-group">
                        <h5 class="mb-0"><?php echo e(@Helper::language('contact_details_web')); ?></h5>
                        <?php
                        ?>
                    ...
                    <div class="checkout-heading-flex-group">
                        <h5 class="mb-0"><?php echo e(@Helper::language('select_store_web')); ?></h5>
                    ...
                    <form class="checkout-form" >
                        ...
                        <div class="location-permission" style="display: none;" >
                            <?php if($storeMapData->count() > 0): ?>
                            <?php  ?>
                            <?php $__currentLoopData = $storeMapData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $map): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
                        
                            <div class="address-group radio-group">
                                <div class="radio-btn">
                                    <input id="radioStoreLocation<?php echo e($key); ?>" type="radio" name="store_location_radio" class="addressRadioCurrent" value="<?php echo e(@$map->id); ?>" />
                                    <label onclick="getStoreAddress('<?php echo e($map->id); ?>')" for="radioStoreLocation<?php echo e($key); ?>"></label>
                                    <div class="detail">


                                        <p class="title-two black-text mb-0"><?php echo e(@$map->store_name); ?></p>
                                        <address class="title-two black-text mb-0"><?php echo e($map->address); ?></address>
                                        <?php
                                        ...
                                        <span class="title-two grey-text mb-0"><?php echo e(@Helper::language('business_hours')); ?> : <?php echo e($start_time); ?> to <?php echo e($end_time); ?> </span>
                                        <?php endif; ?>
                                        <?php
                                            $contactNumber = '';
                                            if($map->phone_code){
                                        ...
                                        <?php if($contactNumber!=""): ?>
                                            <p class="d-flex align-item-center title-two grey-text mb-0">Contact number: <a href="tel:<?php echo e(@$contactNumber?:''); ?>"><?php echo e(@$contactNumber?:''); ?></a></p> 
                                        <?php endif; ?>
                                        <span class="title-two text-green mb-0"><?php echo e(@Helper::language('In_store_pickup_only_label')); ?></span>
                                    </div>
                                </div>
                                <span class="store-pin text-sm black-text mb-0"><i class="icon-location"></i><?php echo e(number_format(@$map->distance,2)); ?> mi</span>
                            </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                ...
                <div class="col-xl-4 col-md-6 checkout-col">
                    <h5 class="checkout-head">2. <?php echo e(@Helper::language('payment_method_label')); ?></h5>
                    <form class="checkout-form">
                ...
                <div class="payment-group-block mb-0">
                    <div class="radio-group mb-0">
                        ...
                        <label for="CashOnDelivery"> <?php echo e(@Helper::language('cash_on_delivery_label')); ?></label>
        ...
        <div class="col-xl-4 col-md-6 checkout-col">
            <h5 class="checkout-head">3. <?php echo e(@Helper::language('order_summary')); ?></h5>
            <div class="order-summary-body">
                ...
                <div class="cart-item-list toggled-on">
                    ...
                    <div class="single-product">
                        <div class="product-img">
                            <a href="<?php echo e(route('productdetails', ['id' => Helper::encodeUrl($result->get_product_details->id)])); ?>">
                                <?php if(file_exists(public_path() . '/uploads/product/' . $product_image->image)): ?>
                                <img src="<?php echo e(asset('uploads/product/' . $product_image->image)); ?>" title="<?php echo e($product_title); ?>" alt="<?php echo e($product_title); ?>" />
                                <?php else: ?>
                        ...
                        <div class="product-detail">
                            <div class="product-detail-main">
                                <h6><a href="<?php echo e(route('productdetails', ['id' => Helper::encodeUrl($result->get_product_details->id)])); ?>" class="heading-six mb-0"><?php echo e($product_title); ?></a></h6>
                                <p class="quantity"> <?php echo e(@Helper::language('volume')); ?><span>: <?php echo e(@$result->variant_size ? $result->variant_size . ' ' . $product_unit : ''); ?></span></p>
                                <?php
                                if(empty($variant_quantity)){
                                    $qty = Helper::getUserCartQuantity($result->id,$user_id);
                                }else{
                                ...
                                ?>
                                 <span class="counters mb-0">
                                    <input class="counters__input" type="text"
                                        ...
                                        name="counters" size="5" id="qty_ince_<?php echo e($result->id); ?>" readonly="readonly" />
                                    <a class="counters__increment" onclick="quntityIncreaseOrDecrease('<?php echo e(Helper::encodeUrl($result->get_product_details->id)); ?>','<?php echo e($result->id); ?>','incr',<?php echo e($is_offer ?? 0); ?>);"  href="javascript:void(0)" data-id="<?php echo e($result->id); ?>">
                                    ...
                                    <a class="counters__decrement" style="cursor: pointer;"  onclick="quntityIncreaseOrDecrease('<?php echo e(Helper::encodeUrl($result->get_product_details->id)); ?>','<?php echo e($result->id); ?>','desc',<?php echo e($is_offer ?? 0); ?>);">
                                        <svg width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="javascript:void(0)" onclick="removeCartItem('<?php echo e($result->id); ?>')" class="link-button"><?php echo e(@Helper::language('remove_btn')); ?></a>
                                </li>
                                <input type="hidden" name="offer_status[]" value="<?php echo e($is_offer); ?>">
                                <input type="hidden" name="offer_type[]" value="<?php echo e($offer_type ?? ''); ?>">
                                <input type="hidden" name="discount_amount[]" value="<?php echo e($discount_amount ?? 0); ?>">
                                <input type="hidden" name="bogo_status[]" value="<?php echo e($is_bogo); ?>">
                                <input type="hidden" value="<?php echo e($result->id); ?>" name="pvariant_Ids[]">
                                <input type="hidden" value="<?php echo e($qty?:0); ?>" name="buy_quantity[]">
                                <input type="hidden" value="<?php echo e(@$result->variant_price); ?>" name="buy_org_price">
                                <input type="hidden" value="<?php echo e(@$result->variant_discounted_price); ?>" name="buy_discounted_price">
                            </ul>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <input type="hidden" name="discount_flag" id="discount_flag" value="<?php echo e(isset($discountFlag) && $discountFlag ? 1 : 0); ?>">
                <input type="hidden" name="discount_amount" id="discount_amount" value="<?php echo e($discountTotal); ?>">
                <input type="hidden" name="freeItemCount" id="freeItemCount" value="<?php echo e(count($freeItems)); ?>">
                <input type="hidden" value="<?php echo e($total_quantity); ?>" name="basket_quantity" id="basket_quantity">


                
                <!-- Free Items Section -->
                <?php if(count($freeItems) > 0): ?>
                    <div class="cart-item-list toggled-on free-item-section">
                        <h5>
                            You have unlocked <?php echo e(count($freeItems)); ?> free <?php echo e(count($freeItems) === 1 ? 'item' : 'items'); ?>! 
                            <i class="fas fa-smile" style="font-size: 20px;"></i>
                        </h5>
                        <?php $__currentLoopData = $freeItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $freeItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                     <a href="#">
                                    <?php if($product_image && file_exists(public_path('uploads/product/' . $product_image->image))): ?>
                                        <img src="<?php echo e(asset('uploads/product/' . $product_image->image)); ?>" alt="<?php echo e($product_title); ?>" />
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('assets/frontend/images/image-not-avilable.png')); ?>" alt="Image not available" />
                                    <?php endif; ?>
                                     </a>
                                </div>
                                <div class="product-detail">
                                    <div class="product-detail-main">
                                        ...
                                        <p class="quantity"> <?php echo e(@Helper::language('volume')); ?><span>: <?php echo e(@$freeItem->variant_size ? $freeItem->variant_size . ' ' . $product_unit : ''); ?></span></p>
                                        <?php
                                        if(empty($variant_quantity)){
                                        ...
                                        ?>
                                        <p class="quantity"> Free <?php echo e(@Helper::language('quantity')); ?>: <span><?php echo e($qty); ?></span></p>
                                    </div>
                                    <ul>
                                        <li class="product-pricing">
                                            <h5>
                                                <?php echo e('0'); ?> <?php echo e(Helper::Settings('currency_symbol')); ?>
                ...
                <div class="form-group mb-30">
                    <div class="loyalty-points-form-group">
                        <label for=""><i class="icon-discount"></i><?php echo e(@Helper::language('coupons')); ?></label>
                        <input type="text" id="coupon" value="" required="" placeholder="<?php echo e(@Helper::language('apply_coupons_plac')); ?>">
                        <button class="link-button remove-btn" id="apply-coupon"><?php echo e(@Helper::language('apply')); ?></button>
                        <a onclick="location.reload();" style="display: none;" class="link-button remove-btn" id="clear-coupon"><?php echo e(@Helper::language('clear')); ?></a>
               ...
               <?php if(auth()->guard('user')->check() && !auth()->guard('user')->user()->is_guest_user): ?>
                <div class="form-group mb-30">
                    ...
                    <div class="reward-container" id="rewardSection">
                        <div class="reward-boxes">
                            <div class="box">
                            <h2><?php echo e($totalPoints); ?></h2>
                            <p><strong>Reward Points</strong><br>You have</p>
                            </div>
                            <div class="box">
                            <?php if($loyaltyInfo): ?>
                                <h2><?php echo e(Helper::Settings('currency_symbol')); ?> <?php echo e($loyaltyInfo->redeem_ghs_value / $loyaltyInfo->points_per_ghs); ?></h2>
                            <?php else: ?>
                                <h2> - </h2>
                            <?php endif; ?>
                        ...
                        <div class="input-group calculation-container" style="margin-bottom: 10px; display: flex; flex-direction: column;">
                            ...
                            <div class="input-row">
                                ...
                                <span class="amount-display" id="amountDisplay">equals to <?php echo e(Helper::Settings('currency_symbol')); ?> 0.00</span>
                                <span class="clear-display"> <button onclick="location.reload();" style="display: none;" class="remove-btn" id="clear-reward"><?php echo e(@Helper::language('clear')); ?></button></span>
                            </div>
                ...
                <div class="form-group mb-30">
                    ...
                    <div style="margin-bottom: 5px">
                         <img src="<?php echo e(asset('assets/frontend/images/Gift-Card_Icon.png')); ?>" title="Gift-Card" alt="Gift-Card"  width="100" height="80">
                    </div>
                    ...
                    <span style="color: #858584 !important;cursor: default;">Select this option to include personalized message written on a card, enhancing the uniqueness of your gift.
                        <br><b style="color:black" > The cost will be 20.00 <?php echo e(Helper::Settings('currency_symbol')); ?>.</b></span></label>
                    </div>
                ...
                <div class="price-detail">
                    <h6> <?php echo e(@Helper::language('price_detail_label')); ?>( <?php echo e($total_quantity); ?> <?php echo e(@Helper::language('items')); ?>)</h6>
                    <ul class="price-list">

                        <div class="cart-total-summary mb-2">
                            <?php if($finalPrice < $product_discount_price): ?>
                                
                                <li>
                                    <strong>Total MRP:</strong>
                                    <span class="original">
                                        <?php echo e(number_format($product_discount_price, 2)); ?> <?php echo e(Helper::Settings('currency_symbol')); ?>
                                ...
                                <li>
                                    ...
                                    <span class="cart-discount">
                                        - <?php echo e(number_format($discountTotal, 2)); ?> <?php echo e(Helper::Settings('currency_symbol')); ?>
                                ...
                                <li>
                                    ...
                                    <span class="discounted">
                                        <?php echo e(number_format($finalPrice, 2)); ?> <?php echo e(Helper::Settings('currency_symbol')); ?>

                                    </span>
                                </li>
                            <?php else: ?>

                                <li> <strong>Total MRP:</strong> <span><?php echo e(@Helper::numberFormat($original_price)); ?> <?php echo e(Helper::Settings('currency_symbol')); ?></span></li>
                                  <?php if($total_discount_price>0): ?>
                                    <li>
                                        <span>Discount on MRP:</span>
                                        <span class="discounted">
                                            - <?php echo e(number_format($total_discount_price, 2)); ?> <?php echo e(Helper::Settings('currency_symbol')); ?>
                        ...
                        <li><span>Tax ( <?php echo e(Helper::Settings('tax')); ?> %)</span>
                            <?php                          
                            $tax_amount = @Helper::numberFormat(((int) Helper::Settings('tax') / 100) * $product_discount_price);
                            ?>
                            <span id="tax-amount"><?php echo e($tax_amount); ?> <?php echo e(Helper::Settings('currency_symbol')); ?></span>
                        </li>
                        <?php
                        ...
                        <input type="hidden" id="base_total" value="<?php echo e($finalPrice > 0 ? $finalPrice : $product_discount_price); ?>">
                        ...
                        <li style="display:none ;" id="gift_charge_li">
                            ...
                            <span id="gift_charge_text">20.00 <?php echo e(Helper::Settings('currency_symbol')); ?></span>
                        </li>
                    ...
                    <div class="total-amount">
                        <h5><?php echo e(@Helper::language('total_amount_label')); ?></h5>
                        <h5 id="grand-total-amount">
                            <?php echo e(@Helper::numberFormat($finalPrice > 0 ? $finalPrice : $product_discount_price)); ?> <?php echo e(Helper::Settings('currency_symbol')); ?>

                        </h5>
                        <input type="hidden" id="inp-grand-total-amount" value="<?php echo e($finalPrice > 0 ? $finalPrice : $product_discount_price); ?>">
                    </div>
                </div>
                <div class="check-group terms-conditions">
                    ...
                    <label class="form-check-label"><?php echo e(@Helper::language('i_agree_to_the')); ?> <a target="_blank" href="<?php echo e(route('termsCondition')); ?>" class="border-button"><?php echo e(@Helper::language('terms_&_conditions')); ?></a><?php echo e(@Helper::language('and_label')); ?> <a href="<?php echo e(route('privacyPolicy')); ?>" target="_blank" class="border-button"> <?php echo e(@Helper::language('privacy_policy')); ?></a>
                        <p><span class="error red-text" id="terms_conditions_error"></span></p>
                    </label>
                </div>
                <input type="hidden" value="<?php echo e($is_buy_now?:0); ?>" id="buy-now">

                <a href="javascript:void(0)" class="solid-button w-100 fw-bold" style="font-size:1.1rem;" onclick="return placeOrder()"><?php echo e(@Helper::language('place_order_btn')); ?></a>
            </div>
        </div>
    </div>
    </div>
...
<script>
    ...
    var test = $("#addressEditForm").validate({
        ...
        submitHandler: function() {
            ...
            // var checkout_page = 1;
            action_url = "<?php echo e(route('upadte-address')); ?>";
    ...
    $('.EditAddress').click(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(url('/checkoutedit-address')); ?>" + "/" + user_address_id,
            data: {
    ...
    var test2=$("#billAddressEditForm").validate({
        ...
        submitHandler: function() {
            ...
            action_url = "<?php echo e(route('update-bill-address')); ?>";
            var csrf = "<?php echo e(csrf_token()); ?>";
            $.ajax({
                url: action_url,
                data: form_data,
    ...
    $('.EditBillAddress').click(function(e) {
        ...
        $.ajax({
            url: "<?php echo e(url('/checkoutedit-bill-address')); ?>" + "/" + user_address_id,
            data: {
                'user_address_id': user_address_id
            },
            headers: {
    ...
    function SelectedAddressChange(address_id) {
        ...
        action_url = "<?php echo e(route('selected-address')); ?>";
        var csrf = "<?php echo e(csrf_token()); ?>";
        $.ajax({
            url: action_url,
            data: {
    ...
    function placeOrder() {
        ...
        var checkout_user_address = "<?php echo e(\Helper::language('checkout_user_address')); ?>";
        var checkout_store_address = "<?php echo e(\Helper::language('checkout_store_address')); ?>";
        var checkout_payment_error = "<?php echo e(\Helper::language('checkout_payment_error')); ?>";
        var checkout_terms_conditions = "<?php echo e(\Helper::language('checkout_terms_conditions')); ?>";
        ...
        var tax = "<?php echo e(Helper::Settings('tax')); ?>";
       ...
       if(!couponAmount)
       {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('storeCheckout')); ?>",
            beforeSend: function() {
                $(".loader").fadeIn();
                $('.loader').css("visibility", "visible");
            },
    ...
    function checkDeliveryAddressByArea(user_address_id) {
        ...
        if (purchase_type == 1) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('userAreaTax')); ?>",
                success: function(response) {
                    if (response.coupon_code_price != "") {
                        $('#coupon_code_amount_text').text('-' + response.coupon_code_price + "<?php echo e(Helper::Settings('currency_symbol')); ?>");
                    }
                    let grandTotal = parseFloat(response.grand_total_amount);
                    let deliveryFee = parseFloat(response.delivery_fee);
                    if(deliveryFee>0)
                    {
                        $("#delivery_fee").text(deliveryFee.toFixed(2) + " <?php echo e(Helper::Settings('currency_symbol')); ?>");
                    ...
                    $("#grand-total-amount").text(grandTotal.toFixed(2) + " <?php echo e(Helper::Settings('currency_symbol')); ?>");
    ...
    $(document).ready(function() {
        $('#apply-coupon').on('click', function(e) {
            ...
            var coupon_error_msg = "<?php echo e(\Helper::language('coupon_field_is_required')); ?>"; 
            let grandTotalElement = document.getElementById('grand-total-amount');
            let currentTotal = parseAmount(grandTotalElement.innerText);
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.code_id == "") {
                        ...
                        $("#coupon-saved-msg").html(`You just saved <strong>${response.coupon_code_price} <?php echo e(Helper::Settings('currency_symbol')); ?></strong> on your order`);
                        ...
                        $("#tax-amount").text(response.tax_amount + " <?php echo e(Helper::Settings('currency_symbol')); ?>");

                       Swal.fire({
                            icon: 'success',
                            title: `<span style="color: #FBB516; font-weight: bold;">${coupon_code}</span> Applied!`,
                            html: `Hurray! You saved <strong>${response.coupon_code_price} <?php echo e(Helper::Settings('currency_symbol')); ?></strong> from this coupon.`,
    ...
    $(document).ready(function() {
        ...
        $(".radioPurchase").on("change", function() {
            ...
            if (val == 'pickup-order-main') {
                var checkout_location_permission_message = "<?php echo e(\Helper::language('checkout_location_permission_message')); ?>";
                ...
                if (inp_delivery_fee != '') {
                    ...
                    $("#grand-total-amount").text(grand_total_amount + " <?php echo e(Helper::Settings('currency_symbol')); ?>");
                }
...
<script>
  ...
  function calculateAmount() {
    $("#amountDisplay").show();
    const maxPoints = <?php echo e($totalPoints); ?>;
    const conversionRate = <?php echo e($loyaltyInfo ? $loyaltyInfo->redeem_ghs_value / $loyaltyInfo->points_per_ghs : 0); ?>;
    const currencySymbol = `<?php echo e(Helper::Settings('currency_symbol')); ?>`;
    ...
    function applyReward()
    {
          var reward_points = $("#points").val();
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('applyReward')); ?>",
                success: function(response) {
                    let deliveryFee = parseFloat(response.delivery_fee);
                    let grandTotal = parseFloat(response.grand_total_amount);
                    ...
                    if (response.reward_id == "") {
                        ...
                        $('#reward_amount_text').text('-' + response.rewardAmount + " <?php echo e(Helper::Settings('currency_symbol')); ?>");
                        $("#li-reward").show();
                        $("#delivery_li").show();
...
<script>
    ...
    function moveBuyNowToCartSafely(reason = '') {
        ...
        setTimeout(() => {
            navigator.sendBeacon("<?php echo e(url('/move-buy-now-to-cart')); ?>", data);
            hasMovedToCart = true;
...
<script>
    // Closing the reward close
      ...
      function recalculateTotalWithoutReward() {
        ...
        $("#grand-total-amount").text(newTotal.toFixed(2) + " <?php echo e(Helper::Settings('currency_symbol')); ?>");
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/checkout/checkout.blade.php ENDPATH**/ ?>