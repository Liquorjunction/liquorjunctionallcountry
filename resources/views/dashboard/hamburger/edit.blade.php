...
@section('content')
    <div class="padding edit-package">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['hamburger.update',"id"=>$blogData->id],'method'=>'POST', 'files' => true])}}
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label">Long Description <span class="valid_field">*</span></label>
                        <div class="col-sm-10">
                            <textarea class="form-control" id="long_description" name="long_description" autofocus >{{@$blogData->long_description}}</textarea>
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2 col-sm-10">
                        <button type="submit" class="btn btn-primary m-t"><i class="material-icons">&#xe31b;</i> {!! __('backend.edit') !!}</button>
                        <a href="{{ route('hamburger')}}" class="btn btn-default m-t">
