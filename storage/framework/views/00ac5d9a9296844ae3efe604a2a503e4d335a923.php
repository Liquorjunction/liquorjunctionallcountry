<?php $__env->startSection('title','Region | Admin Panel'); ?>
...
<div class="padding website-label">
    ...
    <div class="box">
        ...
        <div class="box-header dker">
            <h3><?php echo e(__('backend.region_management')); ?></h3>
            <small>
                <a href="<?php echo e(route('adminHome')); ?>"><?php echo e(__('backend.dashboard')); ?></a> /
                <span><?php echo e(__('backend.region_management')); ?></span>
            </small>
        </div>
            ...
            <ul class="nav">
                ...
                <li class="nav-item inline">
                    <a class="btn btn-fw primary" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false">
                        ...
                        &nbsp; <?php echo e(__('backend.newRegion')); ?>
        ...
        <?php echo e(Form::open(['route'=>'regionUpdateAll','method'=>'post','id'=>'updateAll'])); ?>
            ...
            <table class="table table-bordered m-a-0" id="label">
                <thead class="dker">
                    <tr>
                        ...
                        <th id="region_title"><?php echo e(__('backend.regionName')); ?></th>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title"><?php echo e(__('backend.AddRegion')); ?></h4>
            </div>
            <form class="cmxform" id="regionForm" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" id="title" class="form-control" onkeypress="return isNumberKey(event)" placeholder="Title [EN]" value="<?php echo e(old('title')); ?>">
                    ...
                    <div class="form-group row">
                        <label class="col-sm-2 form-control-label"><?php echo __('Title [FR]'); ?><span class="valid_field">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" name="title_fr" id="title_fr" class="form-control" onkeypress="return isNumberKey(event)" placeholder="Title [FR]" value="<?php echo e(old('title_fr')); ?>">
...
<script>
    ...
    $(document).on('click', '.edit-region', function(e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('region.edit')); ?>",
            type: 'POST',
            data: 'id=' + region_id,
    ...
    $(document).on('click', '.show-region', function(e) {
        ...
        $.ajax({
            ...
            url: "<?php echo e(route('region.show')); ?>",
            type: 'POST',
            data: 'id=' + region_id,
            success: function(response) {
    ...
    //    function() { 
        $.ajax({
            ...
            url: "<?php echo e(route('region.status_active')); ?>",
            type: 'POST',
            data: 'id='+region_id,
            beforeSend: function(){
                                    // $(".loader").fadeIn();
    ...
    //    function() { 
        $.ajax({
            ...
            url: "<?php echo e(route('region.status_inactive')); ?>",
            type: 'POST',
            data: 'id='+region_id,
            beforeSend: function(){
                                    // $(".loader").fadeIn();
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        function load_data() {
            var action_url = "<?php echo route('region.anyData'); ?> ";
    ...
    function ajaxUpdateAll(csrf, join_selected_values, type) {
        $.ajax({
            url: "<?php echo e(route('regionUpdateAll')); ?>",
            type: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrf
            },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/region/list.blade.php ENDPATH**/ ?>