        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                    ...
                    <a href="{{ route('label') }}">Labels</a> / New Label 
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
            ...
            <div class="box-body">
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="label_name" id="label_key" class="form-control" placeholder="Label Key" value="{{old('label_name')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="label_value" id="label_value" class="form-control" placeholder="Label Value [EN]" value="{{old('label_value')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="label_value_fr" id="label_value" class="form-control" placeholder="Label Value [FR]" value="{{old('label_value_fr')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <select name="label_type" id="label_type" class="form-control">
