    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.store_management') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /{{ __('backend.store_management') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                ...
                {{Form::open(['route'=>'storeUpdateAll','method'=>'post','id'=>'updateAll'])}}
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="label">
                        ...
                        <tr>
                            ...
                            <!-- <th>Id</th> -->
                            <th id="">{{ __('backend.name_of_store') }} </th>
                            <th id="">{{ __('backend.address') }}</th>
                            <th id="">{{ __('backend.store_contact_number') }}</th>
    ...
    <script type="text/javascript">
        ...
        $(document).on('click', '.status_inactive', function(e) {
            ...
            $.ajax({
               ...
               url: "{{ route('store.status_inactive')}}",
               type: 'POST',
               data: 'store_id='+store_id,
               beforeSend: function(){
                                    // $(".loader").fadeIn();
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "{!!  route('store.anyData') !!} ";
