                    ...
                    <form action="#" class="row registration-form" method="POST" enctype="multipart/form-data" id="otp_form">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <!--</span>-->
                                  <span class="text-center body-large text-light-grey" id="some_div"><?php echo e($invert == 1 ? '00:00' : '05:00'); ?></span>
                                <?php
                                //dd($users);
                                ?>
                                <!--<span class="d-block text-center body-large text-light-grey" id=""><?php echo e(@Helper::language('hint')); ?> :<?php echo e(@$users->otp); ?></span>-->
                                <!-- <input type="hidden" name="user_id" value="<?php echo e($users->id); ?>" id ="aaa"> -->
                            </div>
                        </div>
                        <div class="col-12">
...
<script type="text/javascript">
    ...
    $('#otp_form').on("submit", function(e) {
        ...
        $.ajax({
            url: "<?php echo e(route('websiteotpverificationpost')); ?>",
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    function resendOtp() {
        ...
        action_url = "<?php echo e(route('websiteresendotp')); ?>";
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/auth/resendotp.blade.php ENDPATH**/ ?>