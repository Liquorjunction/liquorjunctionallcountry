            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="{{route('faq.create')}}">
    ...
    <script type="text/javascript">
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "{!!  route('faq.anyData') !!} ";
            ...
            else
            {
               $(".has-value:checked").each(function() { 
                ...
                {  
                   ...
                   if(type == 0)
                   {
                       msg = "Are you sure you want to deactive this FAQ?";
                   }
                   else if(type == 1)
                   {
                       msg = "Are you sure you want to active this FAQ?";
                   }
                   else
                   {
