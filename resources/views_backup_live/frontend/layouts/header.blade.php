...
<header id="masthead" class="site-header">
            ...
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-4 col-sm-7">
                    <div class="mobile-header">
                        <button class="mobile-header__menu-button mobile_only backdrop" type="button">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_101_3)">
                                    <path d="M22.5 21H1.50001C0.67155 21 0 20.3284 0 19.5C0 18.6716 0.67155 18 1.50001 18H22.5C23.3285 18 24 18.6716 24 19.5C24 20.3284 23.3285 21 22.5 21Z" fill="black" />
                                    <path d="M22.5 13.5H1.50001C0.67155 13.5 0 12.8284 0 12C0 11.1716 0.67155 10.5 1.50001 10.5H22.5C23.3285 10.5 24 11.1716 24 12C24 12.8285 23.3285 13.5 22.5 13.5Z" fill="black" />
                                    <path d="M22.5 5.99999H1.50001C0.67155 5.99999 0 5.32841 0 4.49995C0 3.67148 0.67155 2.99994 1.50001 2.99994H22.5C23.3285 2.99994 24 3.67148 24 4.49995C24 5.32841 23.3285 5.99999 22.5 5.99999Z" fill="black" />
                                </g>
                                <defs>
                                    ...
                                    <div class="mobile-menu__panel-body">
                                        <ul class="mobile-menu__links">
                                            ...
                                            <li class="main-nav__item" data-mobile-menu-item="">
                                                <a href="{{route('productlist',['id'=>Helper::encodeUrl($result->id)]);}}" class="sidebar_close">{{$category_title}} </a>
                                                ...
                                                <div class="mobile-menu__links-panel" data-mobile-menu-panel>
                                                    <div class="mobile-menu__panel mobile-menu__panel--hidden">
                                                        <div class="mobile-menu__panel-header">
                                                            ...
                                                            <div class="mobile-menu__panel-title">{{$category_title}} </div>
                                                        </div>
                                                        ...
                                                        <div class="mobile-menu__panel-body">
                                                            <ul class="mobile-menu__links second_level">
                                                                ...
                                                                $subcategory_title = ($sub_result->title_fr)?$sub_result->title_fr:$sub_result->title;
                                                                }
                                                                @endphp
                                                                <li data-mobile-menu-item>
                                                                    <a href="{{route('productlist',['id'=>Helper::encodeUrl($result->id)]);}}?sid={{Helper::encodeUrl($sub_result->id)}}">{{ucfirst($subcategory_title)}}</a>
                                                                </li>
                                                                <div class="mobile-menu__divider"></div>
                                                                @endforeach
                                            ...
                                            <li class="main-nav__item" data-mobile-menu-item>
                                                <a href="{{ route('special') }}" class="sidebar_close">
                                                    @php
                                                        $special_title = \Session::get('language') == 1 ? 'Special Offers' : 'Offres Spéciales';
                                                    @endphp
                                                    {{ $special_title }}
                                                </a>
                                            </li>
                        ...
                        <a href="{{route('frontend.home')}}" class="logo"><img src="{{ asset('assets/dashboard/images/liquor-logo.svg')}}" alt="think-celebration-think-liquor-junction" title="Think Celebration Think Liquor Junction" /></a>
                    </div>
                </div>
                <div class="col-lg-9 col-md-8 col-sm-5">
                    <ul class="middle-header-link-nav">
                        ...
                        <li><a href="{{route('customerSupport')}}">{{@Helper::language('customer_support')}}</a></li>
                    </ul>
                    ...
                    <div class="middle-header-bottom">
                        ...
                        <form action="#" class="header-search-form searchForm">
                            <div class="home_search">
                                <input type="search" autocomplete="off" name="" id="search-box" placeholder="{{@Helper::language('search_the_product')}}">
                                <button type="submit" class="search-button search-box-click" disabled><i class="fa-solid fa-magnifying-glass text-white" ></i></button>
                        ...
                        <ul class="middle-header-icon-nav">
                           {{-- @if(!empty($user_id))
                            ...
                            @endif --}}
                            <li>
                                <button class="mobile-header__menu-button mobile_only backdrop d-block d-sm-none" type="button">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_101_3)">
                                            <path d="M22.5 21H1.50001C0.67155 21 0 20.3284 0 19.5C0 18.6716 0.67155 18 1.50001 18H22.5C23.3285 18 24 18.6716 24 19.5C24 20.3284 23.3285 21 22.5 21Z" fill="black" />
                                            <path d="M22.5 13.5H1.50001C0.67155 13.5 0 12.8284 0 12C0 11.1716 0.67155 10.5 1.50001 10.5H22.5C23.3285 10.5 24 11.1716 24 12C24 12.8285 23.3285 13.5 22.5 13.5Z" fill="black" />
                                            ...
                                            <g id="g2799">
                                                <g id="Clip path group">
                                                    ...
                                                    <g mask="url(#mask0_5939_3065)">
                                                        <g id="g2801">
                                                            <g id="g2807">
                                                                <path id="path2809" d="M21.6862 17.3689H23.2968V12.4787L19.2633 8.3111H15.9629V8.31705V17.3245" stroke="#242424" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            </g>
                                                            <g id="g2815">
                                                                <path id="path2817" d="M5.6447 15.6681C6.50429 14.8085 7.89788 14.8085 8.75748 15.6681C9.61702 16.5277 9.61702 17.9215 8.75748 18.7811C7.89788 19.6407 6.50429 19.6407 5.6447 18.7811C4.7851 17.9215 4.7851 16.5277 5.6447 15.6681Z" stroke="#242424" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            </g>
                                                            <g id="g2819">
                                                                <path id="path2821" d="M17.9142 15.6681C18.7738 14.8085 20.1674 14.8085 21.027 15.6681C21.8866 16.5277 21.8866 17.9215 21.027 18.7811C20.1674 19.6407 18.7738 19.6407 17.9142 18.7811C17.0546 17.9215 17.0546 16.5277 17.9142 15.6681Z" stroke="#242424" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            </g>
                                                            <g id="g2823">
                                                                <path id="path2825" d="M2.92383 4.57434V17.3611H4.90987" stroke="#242424" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            </g>
                                                            <g id="g2827">
                                                                <path id="path2829" d="M15.9834 8.31689V4.57425H2.92383" stroke="#242424" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            </g>
                                                            <g id="g2831">
                                                                <path id="path2833" d="M7.80239 4.57446H2.92383" stroke="#242424" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                                            </g>
                                                        </g>
                                                    </g>
                                                </g>
                            ...
                            <li class="fav_list" style="top:3px;">
                                <a href="{{ route('favorite-list') }}" title="{{ @Helper::language('my_favorite_list_label') }}">
                            ...
                            <li class="header-cart">
                                {{-- <a id="cart-url" @if(Auth::guard('user')->user() =="" && Session::get('cart_info')=="" ) onclick="isCartEmpty();" @else href="{{route('cart')}}" @endif> --}}
                                    <a id="cart-url"  href="{{route('cart')}}" title="{{@Helper::language('my_cart')}}" > 
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 22C9.55228 22 10 21.5523 10 21C10 20.4477 9.55228 20 9 20C8.44772 20 8 20.4477 8 21C8 21.5523 8.44772 22 9 22Z" stroke="#242424" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M17 22C17.5523 22 18 21.5523 18 21C18 20.4477 17.5523 20 17 20C16.4477 20 16 20.4477 16 21C16 21.5523 16.4477 22 17 22Z" stroke="#242424" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                            <path d="M2 2H3.31348C3.56088 2 3.68458 2 3.78413 2.04368C3.87185 2.08217 3.94619 2.14408 3.99829 2.22202C4.0574 2.31046 4.07489 2.42803 4.10988 2.66318L4.58584 5.86207L5.64362 13.3269C5.77786 14.2742 5.84498 14.7478 6.08084 15.1043C6.28868 15.4185 6.58664 15.6683 6.93888 15.8237C7.33861 16 7.83647 16 8.83218 16H17.438C18.3859 16 18.8598 16 19.2471 15.8363C19.5886 15.6919 19.8815 15.4592 20.0931 15.1641C20.3331 14.8294 20.4218 14.3824 20.5991 13.4885L21.9302 6.77901C21.9926 6.46437 22.0238 6.30704 21.9786 6.18407" stroke="#242424" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"/>
                                            </svg>
                            ...
                            <li class="site_language">
                                <select class="form-select" aria-label="site_language" name="LanguageChange" id="langchange">
                                    <option style="display:none"></option>
                                    <option @if(\Session::get('language')==1) {{ 'selected' }} @endif value="1" selected="">EN</option>
            ...
            <nav id="site-navigation" class="navigation main-navigation desktop-menu">
                <ul class="nav-menu">
                    ...
                    <li class="nav-item @if($result->subcategory->isNotEmpty()){{'has-children '}} @endif">
                        <a href="{{route('productlist',['id'=>Helper::encodeUrl($result->id)]);}}">{{$category_title}} </a>
                        @if($result->subcategory->isNotEmpty())
                        <div class="sub-menu">
                            <ul>
                                @foreach ($result->subcategory as $sub_result )
                                ...
                                @endphp
                                <li><a href="{{route('productlist',['id'=>Helper::encodeUrl($result->id)]);}}?sid={{Helper::encodeUrl($sub_result->id)}}">{{ucfirst($subcategory_title)}}</a></li>
                                @endforeach
                            </ul>
                        </div>
                        @endif
   ...
   @if(empty($user_id))
        <div class="modal show" id="agePopUp" tabindex="-1" aria-labelledby="agePopUpLabel" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
                ...
                <div class="modal-content border-0 rounded-0">
                    <div class="modal-body px-4 py-5 p-md-5">
                        <div class="logo-modal">
                            <img class="img-fluid" alt="GotoLiquorStore" title="GotoLiquorStore" src="https://www.liquorjunctionghana.com/assets/dashboard/images/liquor-logo.svg" width="640" height="80">
                        </div>
                        <div class="font-weight-bold font-md text-red mb-2" id="no-btn-click-message" style="display: none;">
                        ...
                        <div id="contentDiv">
                            ...
                            <div class="mt-4">
                                <button id="btnAgePopUpNo" type="button" class="btn px-4 btn btn-outline-border mr-2">No</button>
