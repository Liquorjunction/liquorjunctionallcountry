        ...
        <div class="box">
            <div class="box-header dker">
                ...
                <h3><i class="material-icons">
                        &#xe02e;</i> {{ __('backend.topicNew') }} {{ __('backend.storeAddress') }}
                </h3>
                <small>
            ...
            <div class="box-body">
               <!-- <form class="cmxform" id="productForm" method="post" action="" autocomplete="off"> -->
                {{Form::open(['route'=>['wholesalerstore.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'cmsForm' ])}}
           ...
           <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="country" id="country" class="form-control" onkeypress="return isNumberKey(event)"  placeholder="Enter Country" value="{{old('country')}}">
                            @if ($errors->has('country'))
                            <span class="help-block">time
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="state" id="state" class="form-control" onkeypress="return isNumberKey(event)"  placeholder="Enter State" value="{{old('state')}}">
                            @if ($errors->has('state'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="zip_code" id="zip_code" class="form-control" maxlength="10"   placeholder="Enter Zip Code" value="{{old('zip_code')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="street_address" id="street_address" class="form-control"  placeholder="Enter Street Address" value="{{old('street_address')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="address" id="address" class="form-control"  placeholder="Enter Street Address" value="{{old('address')}}">
                            @if ($errors->has('address'))
                            <span class="help-block">
                                <span  style="color: red;" class='validate'>{{ $errors->first('address') }}</span>
                            </span>
                            @endif
                            <input type="hidden" value="{{isset(old('property_latitude')?property_latitude:'')}}" name="property_latitude" id="property_latitude"
                                                            value="">
                            <input type="hidden" name="property_longitude" value="{{isset(old('property_longitude')?property_longitude:'')}}" id="property_longitude" value="">
                        </div>
                    </div>
                    <div class="form-group row">
                            ...
                            <div class="multi-group">
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="time" class="form-control time" name="monday_opening_time" id="monday_opening_time" value="{{old('monday_opening_time')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Close Time</label>
                                        <input type="time" class="form-control time" name="monday_close_time" id="monday_close_time" value="{{old('monday_close_time')}}">
                                    </div>
                                    <div class="col-sm-2">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label>Opening Time</label>
                                        <input type="time" class="form-control" name="tuesday_opening_time" id="tuesday_opening_time" value="{{old('tuesday_opening_time')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Close Time</label>
                                        <input type="time" class="form-control" name="tuesday_close_time" id="tuesday_close_time" value="{{old('tuesday_close_time')}}">
                                    </div>
                                    <div class="col-sm-2">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label>Opening Time</label>
                                        <input type="time" class="form-control" name="wednesday_opening_time" id="wednesday_opening_time" value="{{old('wednesday_opening_time')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Close Time</label>
                                        <input type="time" class="form-control" name="wednesday_close_time" id="wednesday_close_time" value="{{old('wednesday_close_time')}}">
                                    </div>
                                    <div class="col-sm-2">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label>Opening Time</label>
                                        <input type="time" class="form-control" name="thursday_opening_time" id="thursday_opening_time" value="{{old('thursday_opening_time')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Close Time</label>
                                        <input type="time" class="form-control" name="thursday_close_time" id="thursday_close_time" value="{{old('thursday_close_time')}}">
                                    </div>
                                    <div class="col-sm-2">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label>Opening Time</label>
                                        <input type="time" class="form-control" name="friday_opening_time" id="friday_opening_time" value="{{old('friday_opening_time')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Close Time</label>
                                        <input type="time" class="form-control" name="friday_close_time" id="friday_close_time" value="{{old('friday_close_time')}}">
                                    </div>
                                    <div class="col-sm-2">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label>Opening Time</label>
                                        <input type="time" class="form-control" name="saturday_opening_time" id="saturday_opening_time" value="{{old('saturday_opening_time')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Close Time</label>
                                        <input type="time" class="form-control" name="saturday_close_time" id="saturday_close_time" value="{{old('saturday_close_time')}}">
                                    </div>
                                    <div class="col-sm-2">
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <label>Opening Time</label>
                                        <input type="time" class="form-control" name="sunday_opening_time" id="sunday_opening_time" value="{{old('sunday_opening_time')}}">
                                    </div>
                                    <div class="col-sm-4">
                                        <label>Close Time</label>
                                        <input type="time" class="form-control" name="sunday_close_time" id="sunday_close_time" value="{{old('sunday_close_time')}}">
                                    </div>
                                    <div class="col-sm-2">
...
@endsection
@push('after-scripts')
 <script src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_MAPS_KEY', 'AIzaSyC3ksZwnrjrnMtiZXZJ7cx9YEckAlt3vh4') }}&libraries=places&callback=initialize1"
async defer></script>
...
<script type="text/javascript">
    ...
    function initialize1() {
        ...
        function initialize(lat, long, flag) {
            ...
            $('#myMapaaa').parents('.col-md-12').css({'display':'block'});
