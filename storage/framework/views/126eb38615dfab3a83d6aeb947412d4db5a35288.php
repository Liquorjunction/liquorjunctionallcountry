...
<?php $__env->startSection('title', Helper::language('my_favourite')); ?>
...
<div class="bread-crumb-block">
    ...
    <li class="breadcrumb-item"><a href="<?php echo e(route('frontend.home')); ?>"><?php echo e(@Helper::language('home')); ?></a></li>
            <li class="breadcrumb-item active" aria-current="page"><?php echo e(@Helper::language('my_favourite')); ?></li>
        </ul>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <h2><?php echo e(@Helper::language('my_favorite_list_label')); ?></h2>  
                <div class="row product-listing-row">
                <?php if(count($productIds) > 0): ?>
                    <?php $__currentLoopData = $favourite_Product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-xl-4 col-sm-6 product-listing-col custom">
                        ...
                        <div class="bs-box">
                            ...
                            <div class="bs-content">
                                <h6><a href="<?php echo e(route('productdetails',['id'=>Helper::encodeUrl($result->id)])); ?>" class="heading-six"><?php echo e(@ucfirst($product_title)?: ''); ?></a></h6>
                                ...
                                <div class="button-wrapper" style="display: flex; align-items: center; justify-content: flex-start;">
                                    ...
                                    <input class="favs-icon" type="checkbox" id="fav-item<?php echo e($key); ?>" checked style="display: none;" />
                                    <label class="favs-button" title="<?php echo e(Helper::language('add_to_favourite')); ?>" for="fav-item<?php echo e($key); ?>" onclick="return favorite_btn(<?php echo e($result->id); ?>,<?php echo e($user_id); ?>)" style="cursor: pointer;"></label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12 col-sm-12">
                    <h3 class="text-danger text-center no-result-found"><?php echo e(@Helper::language('no_data_found')); ?></h3>
                </div>
                <?php endif; ?>
                </div>
            </div>
...
<script type="text/javascript">
    function favorite_btn(id, user_id) {
        $.ajax({
            type: "POST",
            dataType: "json",
            url: "<?php echo e(route('favorite-status')); ?>",
            data: {
                'id': id,
                'user_id': user_id
            },
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/my-profile/favourite.blade.php ENDPATH**/ ?>