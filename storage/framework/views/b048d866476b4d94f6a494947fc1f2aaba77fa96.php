...
<?php $__env->startSection('title',Helper::language('change_password_btn')); ?>
...
<div class="bread-crumb-block">
    ...
    <li class="breadcrumb-item active" aria-current="page"><?php echo e(@Helper::language('change_password_btn')); ?></li>
    </ul>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <h2><?php echo e(@Helper::language('change_password_btn')); ?></h2>
                <div class="common-card">
                    <form class="row change-pass-form" id="change_password_form" novalidate>
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group form-password">
                                <label for=""><?php echo e(@Helper::language('old_password_label')); ?></label>
                                <input type="password" placeholder="Enter <?php echo e(@Helper::language('old_password_label')); ?>" name="old_password" class=" form-password-input">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group form-password">
                                <label for=""><?php echo e(@Helper::language('new_password_label')); ?></label>
                                <input type="password" placeholder="<?php echo e(@Helper::language('enter_new_password_msg')); ?>" name="new_password" id="new_password" class="">
                                <div class="toggle-password">
                                    <button type="button" class="show-password">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g id="icon_eye_open">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group form-password">
                                <label for=""><?php echo e(@Helper::language('confirm_password_label')); ?></label>
                                <input type="password" placeholder="<?php echo e(@Helper::language('enter_confirm_password')); ?>" name="confirm_password" id="confirm_password" class="">
                                <div class="toggle-password">
                                    <button type="button" class="show-password">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <g id="icon_eye_open">
...
<script type="text/javascript">
    $("#change_password_form").validate({
        submitHandler: function() {
            ...
            action_url = "<?php echo e(route('update-password')); ?>";
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/my-profile/change-password.blade.php ENDPATH**/ ?>