...
<div class="padding list-school">
    ...
    <div class="box">
        ...
        <div class="box-header dker">
            <h3>Withdraw History<h3>
                    <small>
                        ...
                        <span href="javascript:void(0);">Withdraw History</span>
                    </small>
        </div>
        ...
        <div class="row margin filter_message" style="">
            <div class="col-xs-6">
            ...
            <div class="col-xs-6">
                ...
                <div class="bulk-action" style="float: right;">
                    ...
                    <?php $report =  route('user-withdraw-history'); ?>
            ...
            <span class="removeError1" style="color: red; display: none; margin-right: -2px;" id="span">Please select start date and end date
            </span>
        </div>
...
<script type="text/javascript">
    $(function() {
        ...
        function load_data(from_date, to_date) {
            ...
            var action_url = "{!!  route('withdraw-history.data') !!} ";
