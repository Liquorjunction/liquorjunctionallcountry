...
@section('title','Purchase Order | Admin Panel')
@section('content')
...
<p><u><a href="{{ asset('uploads/test_formate.xlsx') }}" download style="color: blue;">Click here</a></u>&nbsp; to download sample file</p>
</div>
</div>
</div>
<div class="modal-footer">
...
<script type="text/javascript">
     $('#myModalImport form')[0].reset();
                ...
                submitHandler: function(){
                    ...
                    action_url = "{{ route('adminpurchaseorder.store') }}";
                    var csrf = "{{ csrf_token() }}";
                    $.ajax({
                            url: action_url,
                            data: form_data,
                            ...
                            success: function(data){
                               ...
                               // return false;
                                if (data.success) {
                                    // $('.loader').css("visibility", "visible");
                                    window.location.href = "{{ route('adminpurchaseorder')}}";
                                }
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "{!!  route('adminpurchaseorder.anyData') !!} ";
