...
<link rel="apple-touch-icon" href="{{ asset('assets/dashboard/images/liquor.png')}}">
<meta name="apple-mobile-web-app-title" content="Smartend">
<base href="{{ route('adminHome') }}">
<meta name="csrf-token" content="{{ csrf_token() }}">

<meta name="mobile-web-app-capable" content="yes">
<!-- <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/dashboard/images/OnlyDance Favicon 32x32px.png')}}"> -->
<link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/dashboard/images/liquor.png')}}">
@stack('before-styles')
