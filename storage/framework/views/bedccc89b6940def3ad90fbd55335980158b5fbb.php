...
<script>
    $(document).ready(function(){
       $("#langchange").on('change', function(){
            ...
            let url = "<?php echo e(route('frontend.changeLanguage')); ?>";
            $.ajax({
                url: url,
                type: 'post',
                data: {
...
<script type="text/javascript" src="<?php echo e(asset('assets/frontend/js/jquery.min.js')); ?>"></script>
    ...
    <!-- End Bootstrap JS -->
    <!-- Xzoom -->
    <script type="text/javascript" src="<?php echo e(asset('assets/frontend/js/xzoom.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/frontend/js/xzoom-slider-setup.js')); ?>"></script>
    <!-- Xzoom End -->
    <!-- Xzoom New -->
    <!-- <script type="text/javascript" src="<?php echo e(asset('assets/frontend/js/zoom-image.js')); ?>"></script> -->
    <!-- Xzoom New End -->
    <!-- Swiper Slider JS -->
    <script type="text/javascript" src="<?php echo e(asset('assets/frontend/js/swiper-bundle.min.js')); ?>"></script>
    ...
    <script type="text/javascript" src="<?php echo e(asset('assets/frontend/js/npm-sweetalert.js')); ?>"></script>
    ...
    </script><?php /**PATH /var/www/liquour_junction/well-known/resources/views/frontend/layouts/foot.blade.php ENDPATH**/ ?>