<?php
    ...
    //     $html .= '<li data-index="'.$i.'"><a href="'.$categoryroute.'" ><span class="top-content">'.ucwords($title).'</span></a> </li>';
    //     $i++;
    // }
    ...
    foreach($productDataFilter as $result){
        ...
        $html .= '<li data-index="'.$i.'"><a href="'.$productroute.'"><span class="top-content">'.ucwords($product_name).'</span ></a> </li>';
        $i++;
    }
    echo  $html ;
?>