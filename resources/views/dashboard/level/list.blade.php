        ...
        <div class="box-tool">
            <ul class="nav">
                ...
                <li class="nav-item inline">
                    <a class="btn btn-fw primary" href="{{route('level.create')}}">
...
<script type="text/javascript">
    $(function() {
        ...
        function load_data() {
            ...
            var action_url = "{!!  route('level.anyData') !!} ";
        ...
        if (type == 'no') {
            ...
            if (allVals.length <= 0) {
                ...
                if (type == 0) {
                    ...
                    msg = "Are you sure you want to delete this level?";
                }
