    ...
    <div class="bread-crumb-block">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('my-order')); ?>"><?php echo e(Helper::language('my_order')); ?> </a></li>
                <li class="breadcrumb-item active" aria-current="page"><?php echo e(Helper::language('order_detail')); ?></li>
            </ul>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8">
                    <h2><?php echo e(Helper::language('order_detail')); ?></h2>
                    <div class="row">
                        <?php if($orderInformation->order_status == 3): ?>
                            <div class="col-12 d-flex justify-content-end mb-2">
                                <div class="">
                                    <a class="solid-button" href="<?php echo e(route('printMyOrder', ['id' => $orderInformation->id])); ?>" style="padding: 10px 20px;" target="_blank"> <i class="fas fa-print" style="margin-right: 7px;"></i>Print Invoice</a>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="col-12">
                            <div class="common-card order-list order-details">
                                <ul class="order-detail">
                                    <li>
                                        <span
                                            class="body-normal text-dark d-block mb-1"><?php echo e(Helper::language('order_placed')); ?></span>
                                    ...
                                    <?php if($orderInformation->order_type == 1): ?>
                                        <li>
                                            <span
                                                class="body-normal text-dark d-block mb-1"><?php echo e(Helper::language('deliver_to')); ?></span>
                                            <span class="body-normal text-dark-grey d-block mb-0">
                                                <?php
                                    ...
                                    <li>
                                        <span
                                            class="body-normal text-dark d-block mb-1"><?php echo e(Helper::language('order_type')); ?></span>
                                        <span class="body-normal text-dark-grey d-block mb-0">
                                            <?php if($orderInformation->order_type == 1): ?>
                                                <?php echo e('Online'); ?>
                                    ...
                                    <li class="flex-md-fill">
                                        <span
                                            class="body-normal text-dark d-block mb-1"><?php echo e(Helper::language('order_status')); ?></span>
                                        <span
                                            class="body-normal text-dark-grey d-block mb-0"><?php echo e(Helper::getOrderStatus($orderInformation->order_status)); ?></span>
                                    </li>
                                    
                                    <li>
                                        <span
                                            class="body-normal text-dark-grey d-block mb-1"><?php echo e(Helper::language('order')); ?>

                                            #<?php echo e(@$orderInformation->order_id); ?></span>
                                        <span class="body-normal text-black text-bold d-block mb-0">
                                            <?php echo e(Helper::language('payment_method_label')); ?>:<span
                                ...
                                <div class="order-details-info">
                                    <div class="row">
                                        <div class="col-lg-8 col-sm-6 address-column">
                                            <div class="common-card account-address">
                                                ...
                                                ?>
                                                    <p class="title-two"><?php echo e(@$name ?: ''); ?></p>
                                                    <address class="body-large title-two">
                                                        <?php
                                                        echo implode(', ', $order_delivery_address);
                                                        ?>
                                                    </address>
                                                    <a tel="<?php echo e(@$number ?: ''); ?>"
                                                        class="body-large"><?php echo e(@$number ?: ''); ?></a>

                                                    <div class="mt-3">
                                                        <?php if($orderData->delivery_options): ?>
                                                        <h5>Delivery Instructions</h5>
                                                            <div style="margin-bottom:10px;">
                                                                ...
                                                                <p class="gift-detail">
                                                                    ...
                                                                    <b>Drop-off</b> :- <?php echo e($str); ?></p>
                                                            </div>
                                                         <?php endif; ?>
                                                         <?php if($orderData->delivery_instructions): ?>
                                                         <div style="margin-bottom:10px;">
                                                             <p class="gift-detail"><b>Delivery Message</b> :- <?php echo e($orderData->delivery_instructions); ?></p>
                                                         </div>
                                                         <?php endif; ?>
                                                    </div>
                                                    <?php                    
                                                ...
                                                ?>
                                                <?php elseif($orderInformation->order_type == 2): ?>
                                                    <h5><?php echo e(Helper::language('pickup_order')); ?></h5>
                                                    <?php
                                                ...
                                                ?>
                                                    <p class="title-two"><?php echo e(@ucfirst($name) ?: ''); ?></p>
                                                    <address class="body-large title-two">
                                                        <?php
                                                        echo implode('', $order_pickup_address);
                                                        ?>
                                                    </address>
                                                    <a tel="<?php echo e(@$storenumber ?: ''); ?>"
                                                        class="body-large"><?php echo e(@$storenumber ?: ''); ?></a>
                                                    <?php
                                                    }
                                                ?>
                                                    <?php
                                        ...
                                        <div class="col-lg-4 col-sm-6 col-12">
                                            ...
                                            <ul class="order-summary-list mb-0">
                                                <li>
                                                    <span
                                                        class="heading-six mb-0"><?php echo e(Helper::language('price_detail_label')); ?>(<?php echo e(@count($orderInformation->order_details) ?: ''); ?>

                                                        <?php echo e(Helper::language('items')); ?>)</span>
                                                </li>
                                                <li>
                                                    <span
                                                        class="body-large text-dark-grey"><?php echo e(Helper::language('total_mrp')); ?></span>
                                                        ...
                                                        <?php
                                                            ...
                                                            if ($orderInformation->order_details) {
                                                                foreach ($orderInformation->order_details as $result) {
                                                                    // if bogo
                                                                    $effectiveQty = ($result->is_bogo) ? floor($result->quantity / 2) : $result->quantity;
                                                ...
                                                <?php if($product_discount_amount != 0): ?>
                                                    <li>
                                                        <span
                                                            class="body-large text-dark-grey">Discount On MRP</span>
                                                        <span class="body-large text-green"> -
                                                            <?php echo e(@Helper::numberFormat($product_discount_amount) . ' ' . Helper::Settings('currency_symbol')); ?>

                                                        </span>
                                                    </li>
                                                <?php endif; ?>
                                                 <?php if(isset($orderInformation->cart_discount) && $orderInformation->cart_discount != 0): ?>
                                                    <li>
                                                        <span class="body-large text-dark-grey">Cart  <?php echo e(Helper::language('discount_label')); ?></span>
                                                        <span class="body-large text-green"> - <?php echo e(@Helper::numberFormat($orderInformation->cart_discount) . ' ' . Helper::Settings('currency_symbol')); ?></span>
                                                    </li>
                                                <?php endif; ?>
                                                
                                                <?php if(isset($orderInformation->orderInfo->reward_amount) && $orderInformation->orderInfo->reward_amount != 0): ?>
                                                    <li>
                                                        <span class="body-large text-dark-grey">Reward <?php echo e(Helper::language('discount_label')); ?></span>
                                                        <span class="body-large text-green"> - <?php echo e(@Helper::numberFormat($orderInformation->orderInfo->reward_amount) . ' ' . Helper::Settings('currency_symbol')); ?></span>
                                                    </li>
                                                <?php endif; ?>

                                                
                                                <?php if(isset($orderInformation->discount_amount) && $orderInformation->discount_amount != 0): ?>
                                                    <li>
                                                        <span
                                                            class="body-large text-dark-grey"><?php echo e(Helper::language('coupon_discount')); ?></span>
                                                        <span class="body-large text-green">-
                                                            <?php echo e(@Helper::numberFormat($orderInformation->discount_amount) . ' ' . Helper::Settings('currency_symbol')); ?></span>
                                                    </li>
                                                <?php endif; ?>
                                                 <?php if($orderInformation->tax): ?>
                                                    <li>
                                                        <span class="body-large text-dark-grey">Tax</span>
                                                        <span
                                                            class="body-large text-dark-grey"><?php echo e(@Helper::numberFormat($orderInformation->tax) . ' ' . Helper::Settings('currency_symbol')); ?></span>
                                                    </li>
                                                <?php endif; ?>
                                                <?php if(isset($orderInformation->orderInfo->delivery_fee) && $orderInformation->orderInfo->delivery_fee != 0): ?>
                                                    <li>
                                                        <span
                                                            class="body-large text-dark-grey"><?php echo e(Helper::language('delivery_fee_lab')); ?></span>
                                                        <span class="body-large text-dark-grey">
                                                            <?php echo e(@Helper::numberFormat($orderInformation->orderInfo->delivery_fee) . ' ' . Helper::Settings('currency_symbol')); ?></span>
                                                    </li>
                                                <?php endif; ?>
                                                <?php if(isset($orderInformation->gift_card) && $orderInformation->gift_card != 0): ?>
                                                <li>
                                                    <span
                                                        class="body-large text-dark-grey">Gift Card</span>
                                                    <span class="body-large text-dark-grey">
                                                        <?php echo e(@Helper::numberFormat($orderInformation->gift_card) . ' ' . Helper::Settings('currency_symbol')); ?></span>
                                                </li>
                                                <?php endif; ?>
                                                <li>
                                                    <span
                                                        class="heading-five mb-0"><?php echo e(Helper::language('total_amount_label')); ?></span>
                                                    <span
                                                        class="heading-five mb-0"><?php echo e(@Helper::numberFormat($orderInformation->payable_amount) . ' ' . Helper::Settings('currency_symbol')); ?></span>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <?php if($orderData->note): ?>
                                        <div style="margin-bottom:20px;">
                                            <h5>Notes</h5>
                                            <p style="font-size: 18px;"><b>Note</b> :- <?php echo e($orderData->note); ?></p>
                                        </div>
                                    <?php endif; ?>
                                    <?php if($orderData->recipientName): ?>
                                        <div style="margin-bottom:10px;">
                                            <h5>Additional Details</h5>
                                            <p class="gift-detail"><b>Gift Recipient Name</b> :- <?php echo e($orderData->recipientName); ?></p>
                                            <?php if($orderData->giftMessage): ?>
                                                <p class="gift-detail"><b>Gift Message</b> :- <?php echo e($orderData->giftMessage); ?></p>
                                            <?php endif; ?>
                                        </div>
                                     <?php endif; ?>
                        ...
                        <div class="col-lg-8 mt-30">
                            <ul class="common-card recent-order order-list order-detail-list">
                                <li>
                                    <div class="order-detail-heading">
                                        <h5 class="mb-0">
                                            <?php echo e(Helper::language('total_Item')); ?>(<?php echo e(@count($orderInformation->order_details) ?: ''); ?>)
                                        </h5>
                                ...
                                <li>
                                    <ul class="order-listing">
                                        <?php if($orderInformation->order_details): ?>
                                            <?php $__currentLoopData = $orderInformation->order_details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $result): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php
                                                    ...
                                                    $bogo_status = $result->is_bogo;
                                                ?>
                                                <li>
                                                    <?php if($bogo_status): ?> 
                                                        <div class="mb-2">
                                                                <p><strong>(includes free item from BOGO)</strong></p>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div class="single-product">
                                                        <div class="product-img">
                                                            <a
                                                                href="<?php echo e(route('productdetails', ['id' => Helper::encodeUrl(@$result->product_id)])); ?>">
                                                                <?php if(file_exists(public_path() . '/uploads/product/' . $product_image->image)): ?>
                                                                    <img src="<?php echo e(asset('uploads/product/' . $product_image->image)); ?>"
                                                                        title="<?php echo e($product_title); ?>" />
                                                                <?php else: ?>
                                                        ...
                                                        <div class="product-detail">
                                                            <div class="product-detail-main">
                                                                <h6><a href="<?php echo e(route('productdetails', ['id' => Helper::encodeUrl(@$result->product_id)])); ?>"
                                                                        class="heading-six mb-0"><?php echo e(ucfirst($product_title)); ?></a>
                                                                </h6>
                                                                <p class="quantity"> <?php echo e(Helper::language('volume')); ?>

                                                                    <span>: <?php echo e(@$result->variant_size . ' ' . $unit); ?></span>
                                                                </p>
                                                                <p class="quantity">
                                                                    <?php echo e(Helper::language('quantity')); ?><span>:
                                                                        <?php echo e(@$result->quantity); ?></span></p>
                                                            </div>
                                                            <ul>
                                                                <?php if(@$result->product_total_amount != 0): ?>
                                                                    <li class="product-pricing">
                                                                        <h5><?php echo e(@$result->product_total_amount . Helper::Settings('currency_symbol')); ?><span><?php echo e($result->product_original_amount . Helper::Settings('currency_symbol')); ?></span>
                                                                        </h5>
                                                                    </li>
                                                                <?php else: ?>
                                                                    <li class="product-pricing">
                                                                        <h5><?php echo e(@$result->product_original_amount . Helper::Settings('currency_symbol')); ?>
                                                        ...
                                                        <?php if($orderInformation->order_status == 3): ?>
                                                            ...
                                                            ?>
                                                            <?php if($is_user_reviwed == 0): ?>
                                                                <div class="review_btn">
                                                                    <button class="solid-button extra-design"
                                                                        onclick="getProductId('<?php echo e($result->id); ?>','<?php echo e(@$orderData->id); ?>','<?php echo e($product_info->id); ?>')"
                                                                        data-bs-toggle="modal"
                                                                        data-bs-target="#OrderSuccessfully"
                                                                        id="addReview"><?php echo e(Helper::language('add_review')); ?></button>
                                                                </div>
                                                            <?php endif; ?>
                                                        <?php endif; ?>
                            ...
                            <?php if($orderInformation->order_status==1): ?>
                                <div class="common-card add-review-block">
                                    
                                    <a class="solid-button" onclick='cancellOrder("<?php echo e($orderInformation->uniqid); ?>")'
                        ...
                        <div class="col-lg-4 mt-30">
                            ...
                            $ratingData = DB::table('ratings')
                                ...
                                ->get();
                            ?>
                            <?php if(isset($ratingData) && count($ratingData) > 0): ?>
                                <div class="common-card your-review-block">
                                    <h5 class="mb-3"><?php echo e(Helper::language('your_review')); ?></h5>
                                    <ul class="mb-0">
                                        <li>
                                            <?php $__currentLoopData = $ratingData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rating): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="your-review-box">
                                                    <span
                                                        class="your-review-img"><?php echo e(ucfirst(substr($rating->first_name, 0, 1))); ?>

                                                        <?php echo e(ucfirst(substr($rating->last_name, 0, 1))); ?></span>
                                                    <div class="review-block mb-0">
                                                        <div class="review-star-rating">
                                                            <?php for($i = 1; $i <= round($rating->ratings); $i++): ?>
                                                                <i class="icon-star-fill"></i>
                                                            <?php endfor; ?>
                                                        </div>
                                                        <span class="text-sm"><?php echo e(ucfirst($rating->first_name)); ?>

                                                            <?php echo e($rating->last_name); ?></span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4><?php echo e(Helper::language('add_review')); ?></h4>
                    <form name="reviewform" id="reviewForm">
                        ...
                        <div class="form-group">
                            <label for=""><?php echo e(Helper::language('comment')); ?></label>
                            <textarea name="review" id="review" col="5" rows="2"
                                placeholder="<?php echo e(Helper::language('enter_comment')); ?>"></textarea>
                            <span id="review-error" style="color:#FF4444;float:left;"></span>
                        </div>
                        <button class="solid-button w-100 mt-2"><?php echo e(Helper::language('submit_btn')); ?></button>
...
<?php $__env->startPush('after-scripts'); ?>
    ...
    <script>
        ...
        //     // alert(productId);
        //         $.ajax({
        //         url:"<?php echo e(route('addRating')); ?>",
        //         type:'POST',
        //         data:{
        //             orderId:orderId,
        //             productId:productId,
        ...
        var test = $("#reviewForm").validate({
            ...
            submitHandler: function() {
                ...
                var action_url = "<?php echo e(route('addRating')); ?>";
                var orderId = $('#orderId').val();
                // alert(orderId);
                var productId = $('#productId').val();
                // alert(productId);
        ...
        function cancellOrder(order_id) {
            var url = "<?php echo e(url('cancel-order')); ?>/" + order_id;
            Swal.fire({
                text: "<?php echo e(Helper::language('customer_cancel_order_alert')); ?>",
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/order/order-details.blade.php ENDPATH**/ ?>