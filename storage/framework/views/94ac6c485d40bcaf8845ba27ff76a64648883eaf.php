...
<div class="padding website-label">
    ...
    <div class="box">
        ...
        <div class="box-header dker">
            <h3><?php echo e(__('backend.product_management')); ?></h3>
            <small>
                <a href="<?php echo e(route('adminHome')); ?>"><?php echo e(__('backend.dashboard')); ?></a> / <span><?php echo e(__('backend.product_management')); ?></span>
            </small>
        </div>
        <?php 
        ...
        <div class="box-tool">
            <ul class="nav">
                ...
                <li class="nav-item inline">
                    <a class="btn btn-fw primary" href="<?php echo e(route('product.create')); ?>">
                        <i class="material-icons">&#xe02e;</i>
                        &nbsp; <?php echo e(__('backend.NewProduct')); ?>
...
<?php echo e(Form::open(['route' => 'requestproductUpdateAll', 'method' => 'post', 'id' => 'updateAll'])); ?>
    ...
    <table class="table table-bordered m-a-0 manage-space" id="label">
        <thead class="dker">
            <tr>
                ...
                <!-- <th>Id</th> -->
                <th><?php echo e(__('backend.sku')); ?></th>
                <th >Product Name</th>
                <th><?php echo e(__('backend.brand')); ?></th>
                <th><?php echo e(__('backend.product_category')); ?></th>
                <th><?php echo e(__('backend.product_subcategory')); ?></th>
                <th><?php echo e(__('backend.price')); ?></th>
                <th><?php echo e(__('backend.bestseller')); ?></th>
                <th><?php echo e(__('backend.offer')); ?></th>
...
<div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-tit  <?php if(isset($check_updation_permission) && $check_updation_permission==true): ?><?php endif; ?>"><?php echo e(__('backend.AddCategory')); ?></h4>
            </div>
            <form class="cmxform" id="categoryForm" method="post" action="" autocomplete="off">
                <div class="modal-body">

                    <div class="form-group row">
                        <label class="col-sm-3 form-control-label"><?php echo __('backend.title'); ?> <span class="valid_field">*</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="title" id="title" class="form-control" onkeypress="return isNumberKey(event)" placeholder="Category Title" value="<?php echo e(old('title')); ?>">

                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 form-control-label" style="display: flex;"><?php echo __('backend.description'); ?>
                        ...
                        <div class="col-sm-9">
                            ...
                            <textarea class="form-control" id="description" name="description" placeholder="Category Description"><?php echo e(old('description')); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 form-control-label">Image <span class="valid_field">*</span></label>
                        <div class="col-sm-9">
                            <img id="blah" src="<?php echo e(asset('assets/dashboard/images/no_image_found.jpg')); ?>" alt="your image" />
    ...
    $(document).on('click', '.status_active', function(e) {
        ...
        //     function() {
                $.ajax({
                    ...
                    url: "<?php echo e(route('product.status_active')); ?>",
                    type: 'POST',
                    data: 'id=' + product_id,
                    beforeSend: function() {
                        // $(".loader").fadeIn();
                    ...
                    success: function(response) {
                        $('.loader').css("visibility", "visible");
                        window.location.href = "<?php echo e(route('product')); ?>";
                    },
        ...
        //     },
            // function() {
                $.ajax({
                    ...
                    url: "<?php echo e(route('product.status_inactive')); ?>",
                    type: 'POST',
                    data: 'id=' + product_id,
                    beforeSend: function() {
                        // $(".loader").fadeIn();
...
$(document).on('click', '.bestsellervalue', function(e) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo e(route('product.ischecked')); ?>",
                method: 'POST',
                dataType: 'json',
                data: data,
                beforeSend: function() {
...
$(document).on('click', '.offervalue', function(e) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: "<?php echo e(route('product.offervalue')); ?>",
                method: 'POST',
                dataType: 'json',
                data: data,
                beforeSend: function() {
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        function load_data() {
            ...
            var action_url = "<?php echo route('product.anyData'); ?> ";
    ...
    function ajaxUpdateAll(csrf, join_selected_values, type) {
        $.ajax({
            url: "<?php echo e(route('product.updateAll')); ?>",
            type: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrf
            },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/product/list.blade.php ENDPATH**/ ?>