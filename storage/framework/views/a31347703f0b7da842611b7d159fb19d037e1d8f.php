<div class="modal-header">
    <h4 class="modal-title"><?php echo e(__('backend.EditCustomer')); ?></h4>
</div>
<form class="cmxform" id="customerEditForm" method="post" action="" autocomplete="off">
    <div class="modal-body">
        <div class="form-group row">
            <div class="col-sm-2 form-control-cms" style="display: flex;"><?php echo e(__('backend.firstname')); ?> <span class="valid_field">*</span></div>
            <div class="col-sm-10">
                <input type="text" name="first_name" id="first_name" onkeypress="return isNumberKey(event)" class="form-control" placeholder="First Name" value="<?php echo e(@$customerData->first_name); ?>">
        ...
        <div class="form-group row">
            <div class="col-sm-2 form-control-cms" style="display: flex;"><?php echo e(__('backend.lastname')); ?> <span class="valid_field">*</span></div>
            <div class="col-sm-10">
                <input type="text" name="last_name" id="last_name" onkeypress="return isNumberKey(event)" class="form-control" placeholder="Last Name" value="<?php echo e(@$customerData->last_name); ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-10">
                <input type="text" name="email" id="email" class="form-control" placeholder="Email" value="<?php echo e(@$customerData->email); ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-3">
                <select style="font-size:15px !important;" name="phone_code" id="phone_code" class="form-control">
                    ...
                    <option value="<?php echo e($value->phonecode); ?>" <?php echo e(($customerData->phone_code == $value->phonecode) ? 'selected' : ''); ?>>+<?php echo e($value->phonecode.' ('.$value->shortname.')'); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            <div class="col-sm-7">
                <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone Number" value="<?php echo e(@$customerData->phone); ?>">
        ...
        <!-- <div class="form-group row">
            ...
            <div class="col-sm-9">
                ...
                // if (!empty($customerData->profile)) { 
                    ...
                    <img id="blah" src="<?php echo e(asset('uploads/customer/'.$customerData->profile)); ?>" height="100" width="100"  style="width:100px !important; height:100px !important;" />
                <?php
            //  } else { 
                ?>
    ...
    <div class="modal-footer">
        <input type="hidden" name="customer_id" id="customer_id" value="<?php echo e(@$customerData->id); ?>">
        ...
        $(document).ready(function() {
            ...
            $("#customerEditForm").validate({
                ...
                submitHandler: function() {
                    ...
                    action_url = "<?php echo e(route('customer.store')); ?>";
    ...
    </script><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/customer/edit.blade.php ENDPATH**/ ?>