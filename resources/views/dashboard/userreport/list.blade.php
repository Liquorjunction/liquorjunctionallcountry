...
@section('title','User Report | Admin Panel')
@section('content')
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.UserReport') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                    <span>{{ __('backend.UserReport') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                {{Form::open(['route'=>'export_userreport','method'=>'post','style="background :none !important;"','id'=>'export'])}}
                ...
                {{Form::close()}}
                            ...
                            <!-- <li class="nav-item inline">
                                {{Form::open(['route'=>'export_userpdf','method'=>'post','style="background :none !important;"','id'=>'exportpdf'])}}
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data(startdate, enddate) 
           {
              ...
              var action_url = "{!!  route('userreport.anyData') !!} ";
