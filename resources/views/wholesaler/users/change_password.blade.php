    ...
    <div class="padding edit-package">
        <div class="box">
            <div class="box-header dker">
                ...
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.home') }}</a> / Change Password
            ...
            <div class="box-body">
                {!! Form::open(['route' => ['wholesaler-update-password'], 'method' => 'POST','name' => 'edit_password', 'id' => 'edit_password', 'autocomplete' => 'off','class'=>'form-horizontal']) !!}
                <div class="form-group row">
                    ...
                    <div class="col-sm-9  col-lg-9 form-control-label">
                      ...
                      @if(Session::has('errorMessageCurrentPassword'))
                            <span class="help-block">
                                <span  style="color: red;" class='validate'>{{ Session::get('errorMessageCurrentPassword') }}</span>
                            </span>
                      @endif
                ...
                <div class="form-group row">
                    <label for="password"
                           class="col-sm-3  col-lg-3 form-control-label">Confirm Password <span class="valid_field">*</span>
                    </label>
                    <div class="col-sm-9 col-lg-9 form-control-label">
