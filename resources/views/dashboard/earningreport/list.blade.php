...
@section('title','Earning Report | Admin Panel')
@section('content')
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.EarningReport') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                    <span>{{ __('backend.EarningReport') }}</span>
                </small>
            </div>
            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                {{Form::open(['route'=>'export_earningreport','method'=>'post','style="background :none !important;"','id'=>'export'])}}
                ...
                {{Form::close()}}
                            ...
                            <li class="nav-item inline">
                                {{Form::open(['route'=>'export_earningpdf','method'=>'post','style="background :none !important;"','id'=>'exportpdf'])}}
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="label">
                        ...
                        <tr>
                            ...
                            <th id="">Supplier {{ __('backend.email') }}</th>
    ...
    if ((keyCode < 65 || keyCode > 90) && (keyCode < 97 || keyCode > 123) && keyCode != 32)
        ...
        $(function() {
           ...
           function load_data(startdate, enddate) 
           {
              ...
              var action_url = "{!!  route('earningreport.anyData') !!} ";
