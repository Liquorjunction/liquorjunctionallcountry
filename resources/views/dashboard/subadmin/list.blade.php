...
@section('title', 'Subadmin | Admin Panel')
@section('content')
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            <div class="box-header dker">
                <h3>{{ __('backend.subadmin_management') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                    <span>{{ __('backend.subadmin_management') }}</span>
                </small>
            </div>
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary " id="test_id" data-toggle="modal" data-backdrop="static"
                            data-keyboard="false" data-target="#myModal">
                            <i class="material-icons">&#xe02e;</i>
                            &nbsp; {{ __('backend.NewSubadmin') }}
                        </a>
                    </li>
                </ul>
            </div>
            ...
            {{ Form::open(['route' => 'subadminUpdateAll', 'method' => 'post', 'id' => 'updateAll']) }}
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">{{ __('backend.AddSubadmin') }}</h4>
                </div>
                <form class="cmxform" id="subadminForm" method="post" action="" autocomplete="off">
                    <div class="modal-body">
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label" style="display: flex;">{!! __('backend.name') !!}
                                <span class="valid_field">*</span></label>
                            <div class="col-sm-10">
                                <input type="text" name="fullname" id="fullname" class="form-control" onkeypress="return isNumberKey(event)" placeholder="Enter Name"
                                    value="{{ old('fullname') }}">                               
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <img id="blah" style="width: 100px!important; height:100px !important;"  src="{{ asset('assets/dashboard/images/no_image_found.jpg') }}"
                                    alt="your image" />
...
@push('after-scripts')
    ...
    <script>
        ...
        $(document).on('click', '.status_active', function(e) {
            ...
            swal({
                title: "Deactive",
                text: "Are you sure you want to deactive this sub admin?",
                type: "warning",
            ...
            function() {
                $.ajax({
                    ...
                    url: "{{ route('subadmin.status_active') }}",
                    type: 'POST',
                    data: 'customer_id=' + customer_id,
                    beforeSend: function() {
                        // $(".loader").fadeIn();
        ...
        $(document).on('click', '.status_inactive', function(e) {
            ...
            swal({
                title: "Active",
                text: "Are you sure you want to active this sub admin?",
                type: "warning",
                showCancelButton: true,
            ...
            function() {
                $.ajax({
                    ...
                    url: "{{ route('subadmin.status_inactive') }}",
                    type: 'POST',
                    data: 'customer_id=' + customer_id,
                    beforeSend: function() {
                        // $(".loader").fadeIn();
        ...
        $(document).ready(function() {
            ...
            var subadminform = $("#subadminForm").validate({              
                submitHandler: function() {
                    ...
                    $.ajax({
                        ...
                        error: function (errors) {
                            ...
                            $("span#errorMsgName,span#errorMsgEmail,span#errorMsgPhone,span#errorMsgImage").text('');            
                            if (errors.fullname) { 
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data(startdate, enddate) {
                ...
                var action_url = "{!! route('subadmin.anyData') !!} ";
        ...
        $(document).on('submit', '#updateAll', function(e) {
            ...
            if (type == 'no') {
                ...
                if (allVals.length <= 0) {
                    ...
                    var msg = "";
                    if (type == 0) {
                        msg = "Are you sure you want to deactive this subadmin?";
                    } else if (type == 1) {
                        msg = "Are you sure you want to active this subadmin?";
                    } else {
                        msg = "Are you sure you want to delete this subadmin?";
                    }
