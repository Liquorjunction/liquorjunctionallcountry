            ...
            <div class="box-tool">
                <ul class="nav">
                            ...
                            <li class="nav-item inline">
                                <a class="btn btn-fw primary" href="<?php echo e(route('label.create')); ?>">
                                    <i class="material-icons">&#xe02e;</i>
                                    &nbsp; <?php echo e(__('backend.newLabel')); ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered m-a-0" id="label">
                        ...
                        <tr>
                            ...
                            <!-- <th>Id</th> -->
                            <th><?php echo e(__('backend.labelKey')); ?></th>
                            <th><?php echo e(__('backend.labelValue')); ?></th>
                            <th>Label Type</th>
    ...
    <script type="text/javascript">
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "<?php echo route('label.anyData'); ?> ";
            ...
            else
            {
               $(".has-value:checked").each(function() { 
                ...
                {  
                   ...
                   if(type == 0)
                   {
                       msg = "Are you sure you want to deactive this label?";
                   }
                   else if(type == 1)
                   {
                       msg = "Are you sure you want to active this label?";
                   }
                   else
                   {
        ...
        {
            $.ajax({
               url: "<?php echo e(route('labelUpdateAll')); ?>",
               type: 'POST',
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/label/list.blade.php ENDPATH**/ ?>