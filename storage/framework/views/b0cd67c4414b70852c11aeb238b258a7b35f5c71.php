...
<ul class="account-sidebar">
    <li class="sidebar-item">
        <a href="<?php echo e(route('my-account')); ?>" class="sidebar-link <?php echo e(in_array(\Request::route()->getName(), ['my-account','userchange-password','edit-profile']) ? 'active' : ' '); ?>">
        ...
        <?php echo e(@Helper::language('my_account_label')); ?></a>
    </li>
    <li class="sidebar-item">
        <a href="<?php echo e(route('my-address')); ?>" class="sidebar-link <?php echo e(in_array(\Request::route()->getName(), ['my-address','edit-address','add-address']) ? 'active' : ' '); ?>">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="location">
        ...
        <?php echo e(@Helper::language('my_address_label')); ?></a>
    </li>
    <li class="sidebar-item">
        <a href="<?php echo e(route('myOrder')); ?>" class="sidebar-link <?php echo e(in_array(\Request::route()->getName(), ['myOrder','order-detail']) ? 'active' : ' '); ?>">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="my order">
        ...
        <?php echo e(@Helper::language('my_orders')); ?></a>
    </li>
      <li class="sidebar-item">
        <a href="<?php echo e(route('reward-points')); ?>" class="sidebar-link <?php echo e(in_array(\Request::route()->getName(), ['reward-points']) ? 'active' : ''); ?>">
    ...
    <li class="sidebar-item">
        <a href="<?php echo e(route('favorite-list')); ?>" class="sidebar-link <?php echo e(in_array(\Request::route()->getName(), ['favorite-list']) ? 'active' : ' '); ?>">
        <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g id="icon_fill like">
        ...
        <?php echo e(@Helper::language('my_favorite_list_label')); ?></a>
    </li>
    <li class="sidebar-item">
        ...
        <?php echo e(@Helper::language('logout_label_web')); ?></a>
    </li>
</ul>
...
<script src="<?php echo e(asset('assets/frontend/js/jquery.min.js')); ?>"></script>
 ...
 </script><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/layouts/account-sidebar.blade.php ENDPATH**/ ?>