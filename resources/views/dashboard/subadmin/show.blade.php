<div class="modal-header">
    ...
    <h4 class="modal-title">View Sub Admin</h4>
</div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            @if (@$customerData->photo)
                <a href="{{ asset('uploads/customer/') . '/' . $customerData->photo }}" target="_blank">
                    <img src="{{ asset('uploads/customer/') . '/' . $customerData->photo }}" alt="Category Image"
                        height="100" width="100">
                </a>
            @else
                <div> <img src="{{ asset('assets/dashboard/images/no_image_found.jpg') }}" alt="Category Image"
