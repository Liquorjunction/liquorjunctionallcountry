...
@section('content')
    <div class="padding edit-package">
        <div class="box">
            ...
            <div class="box-body">
                {{Form::open(['route'=>['inquiry.store'],'method'=>'POST', 'files' => true,'enctype' => 'multipart/form-data', 'id' => 'faqForm' ])}}
                ...
                <div class="personal_informations">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="message" name="message" autofocus >{{old('message')}}</textarea>
