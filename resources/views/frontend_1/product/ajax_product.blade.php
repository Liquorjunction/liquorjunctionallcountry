    ...
    <div class="col-lg-3 col-md-4 col-sm-6 product-listing-col">
        <div class="bs-box">
            ...
            <input class="fav-icon checked_box" type="checkbox" id="fav-item{{$key2}}" value="{{ ($fav_data != "") ? '1' : "0" }}" {{ ($fav_data != "") ? 'checked' : "" }} onclick="return productFav({{$result->product_id}},{{ ($fav_data != "") ? '1' : "0" }})" />
