                    ...
                    <form class="row edit-bill-address-form" id="edit_bill_address_form">
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{@$UserAddressData->name}}" placeholder="{{@Helper::language('enter_name_web')}}" name="bill_name" id="bill_name" class="">
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group has-validation">
                                ...
                                <div class="input-group phone-number">
                                    <select class="numbers" name="bill_phonecode" id="bill_phonecode" value="{{@$UserAddressData->phonecode}}">
                                    ...
                                    <input type="tel" value="{{@$UserAddressData->phone}}" placeholder="{{@Helper::language('enter_phone_number_place')}} " name="bill_phone" maxlength="15" id="bill_phone">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="bill_country_id" id="bill_country_id" onchange="getSubCatList(this)" class="form-select" value="{{@$UserAddressData->country_id}}">
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-6" style="margin-bottom:15px ">
                            <div class="form-check" style="display: flex; align-items: center">
                                <input class="form-check-input" type="checkbox" value="" id="defaultAdd" {{@$UserAddressData->default==1 ? 'checked': ''}}>
