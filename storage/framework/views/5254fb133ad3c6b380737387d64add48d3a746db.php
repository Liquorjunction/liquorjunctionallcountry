...
<?php $__env->startSection('title',Helper::language('track_your_order') ); ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="content-inner">
                    <h3><?php echo e(Helper::language('teack_your_order')); ?></h3>
                    <form id="orderStatusForm" class="row">
                        <?php echo csrf_field(); ?>
                        <div class="form-group col-12 col-lg-6">
                            <label for=""><?php echo e(Helper::language('order_numbe_label')); ?></label>
                            <input type="text" id="order_number" name="order_number" placeholder="<?php echo e(Helper::language('enter_order_number')); ?>" value="<?php echo e(old('order_number')); ?>">
                            <span id="order-error" class='red-text'></span>

                        </div>
                        <div class="col-12 col-lg-6" style="margin-top:33px;">
                            <button type="submit" class="solid-button w-100"><?php echo e(Helper::language('check status')); ?></button>
                        </div>
...
<script>
    ...
    $(document).ready(function () {
        $('#orderStatusForm').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo e(route("checkOrderStatus")); ?>',
                method: 'POST',
                data: {
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/cms/help_and_support/trackorder.blade.php ENDPATH**/ ?>