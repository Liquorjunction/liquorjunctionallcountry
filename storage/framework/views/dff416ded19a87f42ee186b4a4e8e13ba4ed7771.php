...
<?php $__env->startSection('title','Bogo Offer'); ?>
            ...
            <div class="box-tool">
                <ul class="nav">
                    <li class="nav-item inline">
                        <a class="btn btn-fw primary" href="<?php echo e(route('bogo.create')); ?>">
     ...
     $(document).on('click', '.status_active', function(e) {
       ...
       function() { 
        $.ajax({
            ...
            url: "<?php echo e(route('bogo.status_active')); ?>",
            type: 'POST',
            data: 'id='+bogo_id,
            beforeSend: function(){
            ...
            success: function (response) {
                $('.loader').css("visibility", "visible");
                window.location.href = "<?php echo e(route('bogo')); ?>";
            },
    ...
    $(document).on('click', '.status_inactive', function(e) {
       ...
       function() { 
        $.ajax({
            ...
            url: "<?php echo e(route('bogo.status_inactive')); ?>",
            type: 'POST',
            data: 'id='+bogo_id,
            beforeSend: function(){
                $('.loader').css("visibility", "visible");
...
<script type="text/javascript">
    $(function() {
        ...
        function load_data(from_date, to_date, search_select, search_data) {
            ...
            var action_url = "<?php echo route('bogo.anyData'); ?> ";
    ...
    function ajaxUpdateAll(csrf, join_selected_values, type) {
        $.ajax({
            url: "<?php echo e(route('bogoUpdateAll')); ?>",
            type: 'POST',
            headers: {
                'X-CSRF-TOKEN': csrf
            },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/bogo/list.blade.php ENDPATH**/ ?>