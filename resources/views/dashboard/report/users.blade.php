...
<div class="padding school-report-manage list-school">
    <div class="box">
        ...
        <div class="row margin filter_message" style="margin-top: -50px;">
            ...
            <div class="col-xs-6">
                {{Form::open(['route'=>'report.users-filter','style="background :none !important;"','method'=>'post','id'=>'filter_form'])}}
                <div class="bulk-action" style="float: right;">
                    ...
                    {{Form::close()}}
                    <!-- {{Form::open(['route'=>'report.users-export-pdf','method'=>'post','style="background :none !important;"','id'=>'export'])}}
                    ...
                    {{Form::close()}} -->
                    {{Form::open(['route'=>'report.users-export','method'=>'post','style="background :none !important;"','id'=>'export1'])}}
                ...
                <thead class="dker">
                    <tr>
                       <th class="width20 dker no-sort" style="display: none;">
                        ...
                        <th>Email</th>
                        <th>Phone</th>
                        <th>Total Class Purchase</th>
                        <th>Created Date/Time</th>
                        <th>Total Earns from User</th>
                    </tr>
                </thead>
                <tbody>
...
<script type="text/javascript">
    $(function() {
        ...
        function load_data(startdate, enddate) {
            ...
            var action_url = "{!!  route('report.users') !!} ";
