...
<section class="product-listing mt-5">
    <div class="container">
        <div class="row" id = "product_list">
            <div class="col-12">
                <div class="short-by">
                    <input type="hidden" name="keyword" id="keyword" value="<?php echo e(@$keyword); ?>">
                    <input type="hidden" name="brand_id" id="brand_id" value="<?php echo e(@$brand_id); ?>">
                ...
                <div class="row product-listing-row" id="table_data">
                    <?php echo $__env->make('frontend.product.ajax_brand', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
                <div class="row">
...
<script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(".load-more-data").click(function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('loadbrandlist')); ?>?sort_by=" + sort_by + "&brand_ids=" +
        ...
        function getProductData() {
            ...
            $.ajax({
                url: "<?php echo e(route('loadbrandlist')); ?>", 
                data: {
                    sort_by: sort_by,
                    brand_ids: brand_ids,
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/frontend/product/brand-list.blade.php ENDPATH**/ ?>