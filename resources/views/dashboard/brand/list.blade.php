...
@section('title', 'Brand | Admin Panel')
@section('content')
@include('sweetalert::alert')
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <div class="box-header dker">
                <h3>{{ __('backend.brand_managment') }}</h3>
                <small>
                    <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                    <span>{{ __('backend.brand_managment') }}</span>
                </small>
            </div>
            @php 
            ...
            {{ Form::open(['route' => 'brandUpdateAll', 'method' => 'post', 'id' => 'updateAll']) }}
            @php 
                ...
                <table class="table table-bordered m-a-0" id="label">
                    <thead class="dker">
                        <tr>                         
                            ...
                            <th id="brand_title">{{ __('backend.brandName') }}</th>
    ...
    <div class="modal fade" id="myModal" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('backend.AddBrand') }}</h4>
                </div>
                <form class="cmxform" id="brandForm" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 form-control-label">{!! __('Title [FR]') !!}<span
                                    class="valid_field">*</span></label>
                            <div class="col-sm-10">
    ...
    $(document).on('click', '.status_inactive', function(e) {
       ...
       function() { 
        $.ajax({
            ...
            url: "{{ route('brand.status_inactive')}}",
            type: 'POST',
            data: 'id='+brand_id,
            beforeSend: function(){
                                    // $(".loader").fadeIn();
   ...
   <script>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            function load_data() {
                var action_url = "{!! route('brand.anyData') !!} ";
