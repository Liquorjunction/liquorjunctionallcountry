...
<?php $__env->startSection('content'); ?>
    ...
    <div class="padding website-label">
        ...
        <div class="box">
            ...
            <?php echo e(Form::open(['route'=>'inquiryUpdateAll','method'=>'post','id'=>'updateAll'])); ?>
    ...
    <script type="text/javascript">
        $(function() {
           ...
           function load_data() 
           {
              ...
              var action_url = "<?php echo route('inquiry.anyData'); ?> ";
            ...
            else
            {
               $(".has-value:checked").each(function() { 
                ...
                {  
                   ...
                   if(type == 0)
                   {
                       msg = "Are you sure you want to deactive this Inquiry?";
                   }
                   else if(type == 1)
                   {
                       msg = "Are you sure you want to active this Inquiry?";
                   }
                   else
                   {
        ...
        {
            $.ajax({
               url: "<?php echo e(route('inquiryUpdateAll')); ?>",
               type: 'POST',
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/liquorjunctiongh/public_html/resources/views/dashboard/inquiry/list.blade.php ENDPATH**/ ?>