...
@section('title','Withdraw History Report')
@section('content')
<style>
...
<div class="padding school-report-manage list-school">
    <div class="box">
        ...
        <div class="box-header dker">
            <h3>Withdraw History Report</h3>
            <small>
                <a href="{{ route('adminHome') }}">{{ __('backend.dashboard') }}</a> /
                <span>Withdraw History Report</span>
            </small>
        </div>
        ...
        <div class="row margin filter_message" style="margin-top: -50px;">
            ...
            <div class="col-xs-6">
                {{Form::open(['route'=>'report.withdraw-history-filter','style="background :none !important;"','method'=>'post','id'=>'filter_form'])}}
                <div class="bulk-action" style="float: right;">
                    ...
                    <?php $report =  route('withdraw-history-report'); ?>
                    ...
                    {{Form::close()}}
                    {{Form::open(['route'=>'report.withdraw-history-export-pdf','method'=>'post','style="background :none !important;"','id'=>'export'])}}
                    ...
                    {{Form::close()}}
                    {{Form::open(['route'=>'report.withdraw-history-export','method'=>'post','style="background :none !important;"','id'=>'export1'])}}
...
<script type="text/javascript">
    $(function() {
        ...
        function load_data(startdate, enddate) {
            ...
            var action_url = "{!!  route('report.withdraw-history') !!} ";
